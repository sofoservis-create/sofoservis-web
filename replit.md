...
- **Medzinárodné sťahovanie hub**: `/medzinarodne-stahovanie` updated as a rozcestník (hub) with links to 31 subpages
  - 16 per-country pages under `/medzinarodne-stahovanie/[krajina]`: rakusko, ceska-republika, nemecko, anglicko, svajciarsko, holandsko, belgicko, francuzsko, madarsko, polsko, taliansko, spanielsko, norsko, svedsko, dansko, irsko
  - 15 per-city pages under `/medzinarodne-stahovanie/[mesto]`: vieden, praha, budapest, mnichov, berlin, frankfurt, hamburg, zurich, londyn, amsterdam, brusel, pariz, dublin, varsava, brno
  - Each page has unique H1, title, meta description, FAQ items and internal linking back to hub and related pages
