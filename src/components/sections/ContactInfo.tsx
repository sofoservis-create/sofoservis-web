...
export default function ContactInfo() {
  ...
  return (
    <section className={`md:pt-14 pb-6 md:pb-10 bg-white ${isKontaktRoute ? "pt-0 mt-[45px] md:mt-0" : "pt-10"}`}>
      {isKontaktRoute && (
        <div className="md:hidden flex justify-center overflow-hidden mb-2" style={{ height: 265, marginTop: -63, transform: 'translateY(-38px)' }}>
      ...
      <Container>
        <div className="w-full flex flex-col md:flex-row-reverse md:items-stretch gap-12 md:gap-16 xl:gap-24">
          ...
          <div className={`w-full md:w-[50%] flex flex-col px-4 sm:px-6 md:px-8 lg:px-12 ${isKontaktRoute ? "-mt-[27.5px] md:mt-0" : ""}`}>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-3 mb-4">
              <div className="flex -space-x-2 flex-shrink-0">
                ...
                <div className="w-9 h-9 rounded-full overflow-hidden ring-2 ring-white relative z-20">
                  <Image
                ...
                <div className="w-9 h-9 rounded-full overflow-hidden ring-2 ring-white relative z-10">
                  <Image
