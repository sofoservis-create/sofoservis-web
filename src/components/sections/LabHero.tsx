...
export default function LabHero({
  ...
  return (
    <>
      <section
        ref={sectionRef}
        className="relative pt-14 pb-6 md:pt-36 md:pb-8 lg:pt-40 bg-primary-900 overflow-hidden"
      ...
      >
        ...
        {/* Glow ellipse — behind mascot (z-4) */}
        <div
        ...
        {/* Mascot — section-level z-5: above bg (z-0), below container content (z-10) */}
        <Image
          ...
          style={narrowForm
            ? { top: '104px', right: '0%', height: '647px', width: 'auto', zIndex: 20 }
            : { top: '104px', right: '5%', height: '647px', width: 'auto', zIndex: 5 }}
          sizes="473px"
        />

        {/* Text content — z-[25] so it renders above the mascot (z-20) */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-[25]">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10 mt-5">
            ...
            <div className={narrowForm ? "p-3 md:p-4" : "p-4 md:p-5"}>
              {submitSuccess ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Popíšte čo potrebujete</label>
                    <textarea
                      name="description"
