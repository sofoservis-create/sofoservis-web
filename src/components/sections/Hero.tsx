...
export default function Hero({
  ...
  ratingText = "2500+ spokojných zákazníkov",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          ...
          <div className="w-full lg:w-3/5 order-1 lg:order-1 space-y-3 md:space-y-5 text-center lg:text-left">
            ...
            <div className="hidden lg:block text-lg md:text-xl text-white/90 max-w-xl leading-relaxed mx-auto lg:mx-0">
              <p>{description}</p>
            </div>
            ...
            <div className="flex flex-row items-center justify-center lg:justify-start gap-3">
              <div className="w-10 h-10 flex-shrink-0 overflow-hidden shadow-lg">
                <Image
                  src="/google.png"
                  alt="Google - certifikát"
                  width={40}
                  height={40}
            ...
            {/* Mobile Form - below Google rating */}
            <div className="block lg:hidden">
            ...
            {/* Benefits Bar - 3 benefits, below form on mobile */}
