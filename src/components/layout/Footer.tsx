...
export default function Footer() {
  ...
  const t = {
    sk: {
      ...
      navigationLinks: [
        { href: "/", label: "Domov" },
        { href: "/stahovanie-bytov-domov", label: "Sťahovanie" },
        { href: "/vypratavanie-bytov-domov", label: "Vypratávanie" },
    ...
    en: {
      ...
      navigationLinks: [
        { href: "/en", label: "Home" },
        { href: "/en/apartment-moving", label: "Moving" },
        { href: "/en/home-junk-removal", label: "Junk Removal" },
