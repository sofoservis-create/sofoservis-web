...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#303030] text-white pt-6 pb-32 desktop:pt-14 desktop:pb-[72px]">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 desktop:px-8">
        ...
        <div className="mt-8 pt-6 desktop:mt-2">
...
function PhoneReveal({
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      >
        <span className={nimbata ? "nimbata_number_1" : ""}>{displayNumber}</span>
        {suffix}
      </a>
    </div>
  );
