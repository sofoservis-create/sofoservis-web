...
// Define the type for navigation category
...
export default function Navbar() {
  ...
  const routeMap: Record<string, string> = {
    ...
    "/vypratavanie-bytov-domov/bratislava": "/en/home-clearance-bratislava",
    "/en/home-clearance-bratislava": "/vypratavanie-bytov-domov/bratislava",
    ...
    "/vypratavanie-pivnic-garazi-nebytovych-priestorov/bratislava": "/en/basement-clearance-bratislava",
    "/en/basement-clearance-bratislava": "/vypratavanie-pivnic-garazi-nebytovych-priestorov/bratislava",
  ...
  const navCategoriesSK: NavCategory[] = [
    ...
    //   name: "MESTÁ",
    //   links: [
    //     { href: "/stahovanie-bratislava", label: "Bratislava" },
  ...
  const DesktopNavItem = ({ category }: { category: NavCategory }) => (
    <div className="relative group">
      ...
      <div className="border border-gray-100 w-60 absolute left-0 top-full min-w-[240px] py-2 mt-1 bg-white rounded-lg shadow-lg invisible opacity-0 translate-y-2 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200 ease-in-out z-50 max-h-[70vh] overflow-y-auto">
    ...
    <>
      ...
      <div
        className={`hidden desktop:block w-full ${
          isScrolled ? "fixed border-1 " : "absolute"
