...
export default function Navbar() {
  ...
  useEffect(() => {
    window.dispatchEvent(new CustomEvent("burgermenu", { detail: { open: mobileMenuOpen } }));
  }, [mobileMenuOpen]);
              ...
              >
                ...
                <div className="desktop:hidden">
                  ...
                  <div className="px-4 pb-5 pt-3">
                    <button
                      type="button"
                      className="w-full flex items-center justify-center gap-2 bg-white border border-accent-500 text-primary-900 py-3 px-3 font-medium rounded-md sm:text-base hover:bg-gray-50 transition-colors cursor-pointer text-[18px]"
                      onClick={() => {
                    ...
                    >
                      ...
                      <span className="whitespace-nowrap overflow-hidden text-[18px] font-bold">{nimbataPhone || t.phoneNumber}</span>
                    </button>
