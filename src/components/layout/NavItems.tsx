...
export const DesktopNavItem = React.memo(function DesktopNavItem({
  ...
  setExpandedSubSubLink,
    ...
    >
      <button className="nav-link px-3 h-24 text-primary-700 font-bold tracking-wide uppercase hover:text-accent-500 transition-colors flex items-center gap-1.5 text-sm group-hover:text-accent-500 whitespace-nowrap">
