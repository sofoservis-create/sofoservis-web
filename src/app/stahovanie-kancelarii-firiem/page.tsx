...
export default function StahovanieKancelariiPage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne sťahovanie kancelárií a firiem od 25€/hod. Minimalizujeme výpadky vašej prevádzky vďaka skúsenému tímu, ktorý sa postará o efektívny a bezpečný presun celej vašej spoločnosti.",
    ...
    <main className="bg-white">
      ...
      <ContactFormSection />
        ...
        services={[
          ...
          { title: "Vypratávanie", description: "Kompletné vypratanie kancelárií a skladov.", href: "/vypratavanie-bytov-domov", icon: "/icons/broom_icon.svg" },
        ]}
      />
    </main>
  );
