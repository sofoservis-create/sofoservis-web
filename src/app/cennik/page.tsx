...
export const metadata = {
  title: "Cenník služieb - Sťahovanie, Vypratávanie, Montáž | Sofoservis",
  description:
    "Transparentné ceny za naše služby. Sťahovanie od 25€/hod, vypratávanie od 25€/hod, montáž nábytku od 20€. Obhliadka zadarmo! Kontaktujte nás pre nezáväznú ponuku.",
  alternates: {
  ...
  return (
    <main className="bg-white">
      ...
      <Hero
        ...
        ratingText="Viac ako 1000+ spokojných zákazníkov"
        benefits={[
          "Transparentné ceny",
