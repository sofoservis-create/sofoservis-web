...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovacie služby v Šamoríne a okolí. Rýchlo, spoľahlivo a za výhodné ceny. Sťahujeme byty, domy, kancelárie a firmy v celom meste a priľahlých oblastiach.",
  keywords:
...
export default function SamorinPage() {
  ...
  const heroData = {
    ...
    description:
      "Kompletné sťahovacie služby v Šamoríne a okolí. Profesionálny tím, výhodné ceny, spokojnosť garantovaná. Sťahujeme byty, domy, kancelárie a firmy v Šamoríne a priľahlých oblastiach.",
