...
export const metadata = {
  ...
  description:
    "Profesionálne vypratávanie bytov, pivníc a starých domov na Starom Meste od 25€/hod. Skúsenosti so starou zástavbou a úzkymi uličkami. Obhliadka zadarmo.",
  alternates: {
...
export default function VypratavanieStareMestoPage() {
  const heroData = {
    ...
    description:
      "Vypratávame byty, pivnice a staré domy na Starom Meste od 25€/hod. Máme skúsenosti so starou zástavbou, úzkymi schodiskami a historickými domami bez výťahu. Obhliadka zadarmo.",
  ...
  return (
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[{"title":"Vypratávanie Bratislava","description":"Vypratávanie bytov a priestorov v Bratislave od 25€/hod.","href":"/vypratavanie-bratislava","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie bytov a domov","description":"Kompletné vypratanie bytu alebo domu.","href":"/vypratavanie-bytov-domov","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie pivníc a garáží","description":"Rýchle vypratanie pivníc, kobiek a garáží.","href":"/vypratavanie-pivnic-garazi-nebytovych-priestorov","icon":"/icons/house_icon.svg"},{"title":"Sťahovanie Staré Mesto","description":"Sťahovanie v Starom Meste od 25€/hod.","href":"/stahovanie-stare-mesto","icon":"/icons/truck_icon.svg"}]}
      />
