...
export default function OdvozStavebnehoOdpaduTrnavaPage() {
  ...
  return (
    <main className="bg-white">
      ...
      />
      <ServicePriceTable variant="vypratavanie" title="Cenník odvozu a likvidácie stavebného odpadu – Trnava" />
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Vypratávanie Trnava", description: "Odvoz starého nábytku.", href: "/vypratavanie", icon: "/icons/vypratavanie_icon.svg" },
        ]}
      />
    </main>
  );
