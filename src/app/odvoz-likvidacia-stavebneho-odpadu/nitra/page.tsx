...
export default function OdvozStavebnehoOdpaduNitraPage() {
  ...
  return (
    <main className="bg-white">
      ...
      />
      <ServicePriceTable variant="vypratavanie" title="Cenník odvozu a likvidácie stavebného odpadu – Nitra" />
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Vypratávanie Nitra", description: "Odvoz starého nábytku.", href: "/vypratavanie", icon: "/icons/vypratavanie_icon.svg" },
        ]}
      />
    </main>
  );
