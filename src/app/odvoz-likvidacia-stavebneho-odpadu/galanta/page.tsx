...
export default function OdvozStavebnehoOdpaduGalantaPage() {
  ...
  return (
    <main className="bg-white">
      ...
      />
      <ServicePriceTable variant="vypratavanie" title="Cenník odvozu a likvidácie stavebného odpadu – Galanta" />
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Vypratávanie Galanta", description: "Odvoz starého nábytku.", href: "/vypratavanie", icon: "/icons/vypratavanie_icon.svg" },
        ]}
      />
    </main>
  );
