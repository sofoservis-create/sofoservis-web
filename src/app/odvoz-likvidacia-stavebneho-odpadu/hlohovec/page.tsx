...
export default function OdvozStavebnehoOdpaduHlohovecPage() {
  ...
  return (
    <main className="bg-white">
      ...
      />
      <ServicePriceTable variant="vypratavanie" title="Cenník odvozu a likvidácie stavebného odpadu – Hlohovec" />
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Vypratávanie Hlohovec", description: "Odvoz starého nábytku.", href: "/vypratavanie", icon: "/icons/vypratavanie_icon.svg" },
        ]}
      />
    </main>
  );
