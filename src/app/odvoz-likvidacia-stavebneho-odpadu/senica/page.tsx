...
export default function OdvozStavebnehoOdpaduSenicaPage() {
  ...
  return (
    <main className="bg-white">
      ...
      />
      <ServicePriceTable variant="vypratavanie" title="Cenník odvozu a likvidácie stavebného odpadu – Senica" />
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Vypratávanie Senica", description: "Odvoz starého nábytku.", href: "/vypratavanie", icon: "/icons/vypratavanie_icon.svg" },
        ]}
      />
    </main>
  );
