...
export const metadata = {
  ...
  openGraph: {
      title: "Odvoz a likvidácia stavebného odpadu, sute | Sofoservis",
      description: "Rýchly odvoz a ekologická likvidácia stavebného odpadu, sute a demolačného materiálu v Bratislave a okolí. Lacné ceny, kontajnery k dispozícii.",
