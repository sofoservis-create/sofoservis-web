...
import ContactFormSection from "@/components/sections/ContactFormSection";
  ...
  export default function VypratavanieSamorinPage() {
    const heroData = {
      ...
      description:
        "Vypratávame byty, pivnice, kobky a garáže v celom Šamoríne od 25€/hod. Odvoz a likvidácia starého nábytku, spotrebičov aj odpadu — všetko v jednej službe. Obhliadka zadarmo.",
