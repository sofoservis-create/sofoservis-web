...
export default function StahovanieBratislavaPage() {
  ...
  const heroData = {
    ...
    description:
      "Kompletné sťahovacie služby v Bratislave a okolí od 25€/hod. Profesionálny tím, spokojnosť garantovaná. Sťahujeme byty, domy, kancelárie a firmy v každej mestskej časti Bratislavy.",
    ...
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Vypratávanie bytov a domov", description: "Kompletné vypratanie a odvoz nepotrebných vecí.", href: "/vypratavanie-bytov-domov", icon: "/icons/broom_icon.svg" },
