...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovacie služby v Komárne a okolí. Rýchlo, spoľahlivo a za výhodné ceny. Sťahujeme byty, domy, kancelárie a firmy v celom meste a prihraničnej oblasti.",
  alternates: {
...
export default function StahovanieKomarnoPage() {
  ...
  const heroData = {
    ...
    description:
      "Kompletné sťahovacie služby v Komárne a okolí. Profesionálny tím, výhodné ceny, spokojnosť garantovaná. Sťahujeme byty, domy, kancelárie a firmy v celom Komárne aj v prihraničných oblastiach.",
