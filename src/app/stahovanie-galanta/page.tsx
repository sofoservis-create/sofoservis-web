...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovacie služby v Galante a okolí. Rýchlo, spoľahlivo a za výhodné ceny. Sťahujeme byty, domy, kancelárie a firmy v Galante a celom regióne.",
  alternates: {
