  ...
  return (
    <main className="bg-white">
      <Hero
        ...
        benefits={["Copenhagen, Aarhus, Odense", "3-4 day delivery to Denmark", "Door-to-door service"]}
      ...
      <div><GoogleReviews showReviewsShowcase={false} title="Reviews from Customers Who Moved to Denmark" /></div>
      <div>
        <FAQ
