...
export const metadata = {
  title: "Home Clearance Staré Mesto Bratislava | Sofoservis",
  description:
    "Professional home clearance services in Staré Mesto, Bratislava ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance staré mesto, house clearance staré mesto, property clearance staré mesto, estate clearance staré mesto",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-stare-mesto",
    languages: {
...
export default function HomeClearanceStareMestoPage() {
  const faqItems = [
    { question: "How does the clearance process work in Staré Mesto?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Staré Mesto?", answer: "The cost depends on space size, amount of items, accessibility (historic buildings often have narrow stairs/no elevators), waste type, and additional services. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Staré Mesto?", answer: "Being based in Bratislava, we can often arrange clearance in Staré Mesto within 24-48 hours. Contact us for the earliest available term." },
    { question: "Do you handle clearance in historic buildings without elevators in Staré Mesto?", answer: "Yes, we specialize in clearance in the Old Town's historic buildings. Our team is experienced in manual carry-down through narrow staircases where elevators are not available." },
  ];

  return (
    <main className="bg-white">
      <Hero
        title="Home Clearance Services in Staré Mesto"
        description="Professional and fast home clearance services in Staré Mesto (Old Town) district of Bratislava. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Clearance in Staré Mesto District"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Staré Mesto"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Staré Mesto?"
