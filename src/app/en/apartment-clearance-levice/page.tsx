...
export const metadata = {
  title: "Apartment & House Clearance Levice | Sofoservis",
  description:
    "Professional apartment and house clearance services in Levice ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance levice, house clearance levice, home clearance levice, property clearance levice",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-levice",
    languages: {
...
export default function ApartmentClearanceLevicePage() {
  const faqItems = [
    { question: "How does the apartment clearance process work in Levice?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment clearance cost in Levice?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange clearance in Levice?", answer: "We can usually arrange clearance in Levice within 2-4 working days." },
  ...
  return (
    <main className="bg-white">
      <Hero
        title="Apartment & House Clearance in Levice"
        description="Professional apartment and house clearance services in Levice. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Levice and Surroundings"
          description="We provide professional clearance services in Levice and nearby areas"
          locations={["Levice","Šahy","Zlaté Moravce","Nová Baňa","Tlmače","Hronské Kľačany","Čajkov"]}
          additionalText="We serve Levice and surrounding towns in the Nitra region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Levice"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Levice?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Levice and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-levice", icon: "/icons/truck_icon.svg" },
        ]}
      />
