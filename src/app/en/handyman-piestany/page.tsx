...
export default function HandymanPiestanyPage() {
  ...
  const heroData = {
    ...
    description:
      "Professional handyman services in Piešťany and surrounding areas for quick and reliable repairs, assembly, and home maintenance. We cover all of Piešťany.",
