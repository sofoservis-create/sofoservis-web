...
export default function ConstructionWasteRemovalNitraPage() {
  ...
  const heroData = {
    ...
    description:
      "Professional and fast construction waste removal and ecological disposal services in Nitra and surrounding areas. We handle waste from renovations.",
  ...
  const featuresData = {
    title: "Complete Construction Waste Removal Services in Nitra",
    description:
