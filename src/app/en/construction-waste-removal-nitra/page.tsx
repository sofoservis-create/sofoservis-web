...
export default function ConstructionWasteRemovalNitraPage() {
  const faqItems = [
            {
              question: "How much does construction waste removal cost in Nitra?",
              answer:
            ...
            {
              question: "How quickly can you arrange waste removal in Nitra?",
              answer:
  ...
  const heroData = {
    title: "Construction Waste Removal in Nitra",
    description:
      "Professional and fast construction waste removal and ecological disposal services in Nitra and surrounding areas. We handle waste from renovations, demolitions, or construction at competitive prices with complete disposal documentation.",
  ...
  return (
    <main className="bg-white">
      ...
      <div className="py-16">
        <LocationMap
          title="Construction Waste Removal Throughout Nitra"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Construction Waste Removal in Nitra"
          items={[
            {
              question: "How much does construction waste removal cost in Nitra?",
              answer:
      ...
      <div>
        <CTA
          title="Need construction waste removed in Nitra?"
