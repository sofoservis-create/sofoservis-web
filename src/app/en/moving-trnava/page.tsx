...
export const metadata = {
  title: "Moving Services Trnava - Apartments, Houses & Offices | Sofoservis",
  description:
...
export default function MovingTrnavaPage() {
  const heroData = {
    title: "Moving Services in Trnava",
    description:
      "Complete moving services in Trnava and surrounding areas. Professional team, competitive prices, satisfaction guaranteed. We move apartments, houses, offices, and businesses throughout Trnava.",
    formTitle: "Hassle-free moving in Trnava with a free quote",
    formSubtitle: "Fill out the form below for a quick fixed price",
    backgroundImage: "/images/stahovanie_gauc.jpg",
  };

  const featuresData = {
    title: "Professional Moving Services in Trnava",
    description:
      "Complete moving solutions for homes and businesses in Trnava and surrounding areas.",
    features: [
      {
        image: "/icons/house_icon.svg",
        title: "Apartment & House Moving in Trnava",
        description:
          "Complete apartment and house moving services in Trnava. We safely transport your furniture and personal belongings to your new home.",
      ...
      },
      {
        ...
        description:
          "Professional office and business relocation in Trnava. We minimize downtime by moving during weekends and holidays.",
      ...
      },
      {
        ...
        description:
          "Expert assembly and disassembly of any furniture during your move in Trnava. We save your time and energy.",
      ...
      },
      {
        ...
        description:
          "We specialize in moving heavy items such as pianos, safes, and large furniture pieces in Trnava.",
        link: "/en/moving-heavy-loads",
      },
      {
        image: "/icons/globe_icon.svg",
        title: "International Moving from Trnava",
        description:
          "Moving from Trnava abroad or vice versa. Complete solution for international relocation with minimum hassle.",
      ...
      },
      {
        ...
        description:
          "Complete property clearance services in Trnava. Ideal for property sales, renovations, or estate settlements.",
  ...
  const mapData = {
    title: "We Move Throughout Trnava",
    description:
      "Our services are available throughout Trnava and surrounding areas for complete home and business relocations.",
    locations: [
          "Trnava city center",
          "Špačince",
          "Bohdanovce",
  ...
  const faqData = {
    title: "Frequently Asked Questions About Moving in Trnava",
    items: [
      {
        question: "Which areas of Trnava do you cover?",
        answer:
          "We provide our services throughout Trnava and all surrounding towns and villages. Contact us for details about service in your specific location.",
      },
      {
        question: "What is the cost of moving in Trnava?",
        answer:
      ...
      {
        question: "How far in advance should I book a move in Trnava?",
        answer:
      ...
      {
        question: "Do you provide furniture assembly and disassembly in Trnava?",
        answer:
      ...
      {
        question: "Can you move heavy items like pianos or safes in Trnava?",
        answer:
    ...
    <main className="bg-white">
      ...
      <div>
        <CTA
          ...
          description="Let us handle your move in Trnava with professional care. Contact us today for a free quote."
