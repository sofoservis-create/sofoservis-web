  ...
  return (
    <main className="bg-white">
      <Hero
        ...
        benefits={["60 km — often same-day", "Door-to-door delivery", "Fully insured"]}
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Moving Bratislava to Vienna", description: "City-to-city Bratislava–Vienna route.", href: "/en/moving-bratislava-vienna", icon: "/icons/truck_icon.svg" },
