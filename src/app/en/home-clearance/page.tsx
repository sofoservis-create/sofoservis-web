...
export const metadata = {
  title: "Home Clearance Services - Apartments & Houses | Sofoservis",
  description:
    "Professional home clearance services for apartments and houses ✅ Cheap and fair prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance, house clearance, apartment clearance, property clearance, furniture removal, junk removal, estate clearance",
  alternates: {
  ...
  openGraph: {
    title: "Home Clearance Services - Apartments & Houses | Sofoservis",
    description:
      "Professional home clearance services with free estimates. Fast, reliable, and eco-friendly disposal!",
...
export default function HomeClearancePage() {
  const faqItems = [
            {
              question: "How does the clearance process work?",
              answer:
                "The process begins with a free site inspection where we estimate the scope of work and prepare a quote. After agreement, we set a date for clearance. On the agreed day, our team arrives with all necessary materials and equipment. We work systematically: first sorting items according to your requirements (what to keep, donate, or dispose of), then packing and removing all unwanted materials, and finally cleaning the space.",
            },
            {
              question:
            ...
            {
              question: "Do you provide estate clearance services?",
              answer:
                "Yes, we specialize in sensitive and discreet estate clearance. We understand this is an emotionally difficult situation, so we approach this service with maximum empathy and respect. We help you sort personal items, documents, and valuables from unwanted items. We ensure careful and dignified clearance of the space including possible cleaning and disinfection.",
            },
          ];
  const featuresData = {
    title: "Comprehensive Home Clearance Services",
    description:
      "Professional property clearance with responsible disposal and recycling of unwanted items. We save you time and energy.",
    features: [
      {
        image: "/icons/house_icon.svg",
        title: "Complete Home Clearance",
        description:
      ...
      },
      {
        ...
        description:
          "After clearance, we also handle construction waste removal, rubble, and demolition materials. Complete service in one place.",
  ...
  return (
    <main className="bg-white">
      <Hero
        title="Home Clearance Services"
        description="Comprehensive services for fast and efficient clearance of apartments, houses, and properties. Our professional team handles everything from sorting items, through packing and removal, to eco-friendly disposal of unwanted waste."
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance"
          items={[
            {
              question: "How does the clearance process work?",
              answer:
      ...
      <div>
        <CTA
          title="Need professional home clearance?"
      ...
      <RelatedServices
          ...
          services={[{"title":"Apartment Moving","description":"Professional home and apartment relocation services.","href":"/en/apartment-moving","icon":"/icons/house_icon.svg"},{"title":"Old Furniture Removal","description":"Fast pickup and eco-friendly disposal of old furniture.","href":"/en/furniture-removal","icon":"/icons/truck_icon.svg"},{"title":"Construction Waste Removal","description":"Quick removal of construction debris, rubble and building waste.","href":"/en/construction-waste-removal","icon":"/icons/recycle_icon.svg"},{"title":"Hazardous Waste Removal","description":"Safe and legal disposal of hazardous materials and old appliances.","href":"/en/hazardous-waste-removal","icon":"/icons/hazmat_icon.svg"}]}
        />
