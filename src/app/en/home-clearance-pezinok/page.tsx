...
export const metadata = {
  title: "Home Clearance Pezinok | Sofoservis",
  description:
    "Professional home clearance services in Pezinok ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance pezinok, house clearance pezinok, property clearance pezinok, estate clearance pezinok",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-pezinok",
    languages: {
...
export default function HomeClearancePezinokPage() {
  const faqItems = [
    { question: "How does the clearance process work in Pezinok?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Pezinok?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Pezinok?", answer: "We can typically arrange clearance in Pezinok within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  const nearbyTowns = ["Modra", "Senec", "Bratislava", "Viničné", "Limbach", "Svätý Jur"];

  const cityIntro =
    "Pezinok is a wine-producing town near Bratislava in the Little Carpathian region. Many older winegrower homes, wine cellars, and garden houses here require professional clearance during renovations or property sales. We cover Pezinok and the entire surrounding wine region.";
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Clearance Services in Pezinok"
          description="Professional and fast home clearance services in Pezinok and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Clearance in Pezinok and Surroundings"
          description="We provide professional services in Pezinok and nearby locations"
          locations={nearbyTowns}
          additionalText="We serve the entire Pezinok district and surrounding areas in the Bratislava region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Pezinok"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Pezinok?"
          description="Let our experienced team handle everything - from sorting items to final space cleaning. We operate in all parts of Pezinok."
