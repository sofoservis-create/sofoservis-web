...
export const metadata = {
  title: "Apartment & House Junk Removal Trnava | Sofoservis",
  description:
    "Professional apartment and house junk removal services in Trnava ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment junk removal trnava, house junk removal trnava, home junk removal trnava, property junk removal trnava",
  alternates: {
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Junk Removal in Trnava"
          description="Professional apartment and house junk removal services in Trnava. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Junk Removal in Trnava and Surroundings"
          description="We provide professional junk removal services in Trnava and nearby areas"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Junk Removal in Trnava"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment junk removal in Trnava?"
