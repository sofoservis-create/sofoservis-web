...
export const metadata = {
  title: "Apartment & House Clearance Senica | Sofoservis",
  description:
    "Professional apartment and house clearance services in Senica ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance senica, house clearance senica, home clearance senica, property clearance senica",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-senica",
    languages: {
...
export default function ApartmentClearanceSenicaPage() {
  const faqItems = [
    { question: "How does the apartment clearance process work in Senica?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment clearance cost in Senica?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange clearance in Senica?", answer: "We can usually arrange clearance in Senica within 2-4 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Clearance in Senica"
          description="Professional apartment and house clearance services in Senica. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Senica and Surroundings"
          description="We provide professional clearance services in Senica and nearby areas"
          locations={["Senica","Skalica","Holíč","Gbely","Myjava","Záhorie"]}
          additionalText="We serve Senica and surrounding towns in the Záhorie region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Senica"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Senica?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Senica and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-senica", icon: "/icons/truck_icon.svg" },
        ]}
      />
