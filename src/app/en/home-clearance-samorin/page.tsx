...
export const metadata = {
  title: "Home Clearance Šamorín | Sofoservis",
  description:
    "Professional home clearance services in Šamorín ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance samorin, house clearance samorin, property clearance samorin, estate clearance samorin",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-samorin",
    languages: {
...
export default function HomeClearanceSamorinPage() {
  const faqItems = [
    { question: "How does the clearance process work in Šamorín?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Šamorín?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Šamorín?", answer: "We can typically arrange clearance in Šamorín within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  const nearbyTowns = ["Dunajská Streda", "Senec", "Bratislava", "Hamuliakovo", "Kvetoslavov", "Hubice"];

  const cityIntro =
    "Šamorín lies on Žitný ostrov near the Danube and is one of the fastest-growing towns in the Bratislava metro area. The mix of traditional village houses, modern villas, and holiday properties creates varied clearance needs. We cover Šamorín and the entire surrounding Žitný ostrov area.";

  return (
    <main className="bg-white">
      <Hero
        title="Home Clearance Services in Šamorín"
        description="Professional and fast home clearance services in Šamorín and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
        formTitle="Get a free price quote"
        formSubtitle="Fill out the form for a no-obligation estimate in Šamorín"
      ...
      <div>
        <LocationMap
          title="Home Clearance in Šamorín and Surroundings"
          description="We provide professional services in Šamorín and nearby locations"
          locations={nearbyTowns}
          additionalText="We serve Šamorín and surrounding areas in the Dunajská Streda district."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Šamorín"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Šamorín?"
          description="Let our experienced team handle everything - from sorting items to final space cleaning. We operate in all parts of Šamorín."
