...
export default function ConstructionWasteRemovalSenecPage() {
  const faqItems = [
            {
              question: "How much does construction waste removal cost in Senec?",
              answer:
            ...
            {
              question: "How quickly can you arrange waste removal in Senec?",
              answer:
  ...
  const heroData = {
    title: "Construction Waste Removal in Senec",
    description:
      "Professional and fast construction waste removal and ecological disposal services in Senec and surrounding areas. We handle waste from renovations, demolitions, or construction at competitive prices with complete disposal documentation.",
  ...
  return (
    <main className="bg-white">
      ...
      <div className="py-16">
        <LocationMap
          title="Construction Waste Removal Throughout Senec"
          description="We operate in all areas of Senec"
          locations={["Senec center","Bernolákovo","Ivanka pri Dunaji","Chorvátsky Grob","Tomášov","Nová Dedinka","Malinovo","Miloslavov","Rovinka","Dunajská Lužná","Most pri Bratislave"]}
          additionalText="We also serve Bratislava, Pezinok, Galanta, and other surrounding towns."
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Construction Waste Removal in Senec"
          items={[
            {
              question: "How much does construction waste removal cost in Senec?",
              answer:
      ...
      <div>
        <CTA
          title="Need construction waste removed in Senec?"
