...
export default function ConstructionWasteRemovalSenecPage() {
  ...
  const heroData = {
    ...
    description:
      "Professional and fast construction waste removal and ecological disposal services in Senec and surrounding areas. We handle waste from renovations.",
  ...
  const featuresData = {
    title: "Complete Construction Waste Removal Services in Senec",
    description:
