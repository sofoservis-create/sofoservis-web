...
export const metadata = {
  title: "Home Clearance Hlohovec | Sofoservis",
  description:
    "Professional home clearance services in Hlohovec ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance hlohovec, house clearance hlohovec, property clearance hlohovec, estate clearance hlohovec",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-hlohovec",
    languages: {
...
export default function HomeClearanceHlohovecPage() {
  const faqItems = [
    { question: "How does the clearance process work in Hlohovec?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Hlohovec?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Hlohovec?", answer: "We can typically arrange clearance in Hlohovec within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  return (
    <main className="bg-white">
      <Hero
        title="Home Clearance Services in Hlohovec"
        description="Professional and fast home clearance services in Hlohovec and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
        formTitle="Get a free price quote"
        formSubtitle="Fill out the form for a no-obligation estimate in Hlohovec"
      ...
      <div>
        <LocationMap
          title="Home Clearance in Hlohovec and Surroundings"
          description="We provide professional services in Hlohovec and nearby locations"
          locations={nearbyTowns}
          additionalText="We serve the entire Hlohovec district and surrounding areas."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Hlohovec"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Hlohovec?"
          description="Let our experienced team handle everything - from sorting items to final space cleaning. We operate in all parts of Hlohovec."
