  ...
  return (
    <main className="bg-white">
      <Hero
        ...
        benefits={["Prague, Brno, Ostrava", "1-2 day delivery", "Door-to-door service"]}
      ...
      <div><GoogleReviews showReviewsShowcase={false} title="Reviews from Customers Who Moved to the Czech Republic" /></div>
      <div>
        <FAQ
