...
export const metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: "https://www.sofoservis.sk/en/home-junk-removal-ruzinov",
      "x-default": "https://www.sofoservis.sk/vypratavanie-ruzinov",
    },
  },
};

export default function HomeJunkRemovalRuzinovPage() {
  const faqItems = [
    { question: "How does the junk removal process work in Ružinov?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home junk removal in Ružinov?", answer: "The cost depends on space size, amount of items, accessibility (floor number, elevator), waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. We provide a free on-site quote." },
    { question: "How quickly can you arrange junk removal in Ružinov?", answer: "Being based in Bratislava, we can often arrange junk removal in Ružinov within 24-48 hours. Contact us for the earliest available term." },
    { question: "Do you handle junk removal in older apartment buildings in Ružinov?", answer: "Yes, we handle junk removal in all types of buildings in Ružinov, from older brick apartment blocks to newer residential developments." },
  ];
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Junk Removal Services in Ružinov"
          description="Professional and fast home junk removal services in Ružinov district of Bratislava. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Junk Removal in Ružinov District"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Junk Removal in Ružinov"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home junk removal in Ružinov?"
