...
export const metadata = {
  title: "Moving Services Galanta - Apartments, Houses & Offices | Sofoservis",
  description:
...
export default function MovingGalantaPage() {
  const heroData = {
    title: "Moving Services in Galanta",
    description:
      "Complete moving services in Galanta and surrounding areas. Professional team, competitive prices, satisfaction guaranteed. We move apartments, houses, offices, and businesses throughout Galanta.",
    formTitle: "Hassle-free moving in Galanta with a free quote",
    formSubtitle: "Fill out the form below for a quick fixed price",
    backgroundImage: "/images/stahovanie_gauc.jpg",
  };

  const featuresData = {
    title: "Professional Moving Services in Galanta",
    description:
      "Complete moving solutions for homes and businesses in Galanta and surrounding areas.",
    features: [
      {
        image: "/icons/house_icon.svg",
        title: "Apartment & House Moving in Galanta",
        description:
          "Complete apartment and house moving services in Galanta. We safely transport your furniture and personal belongings to your new home.",
      ...
      },
      {
        ...
        description:
          "Professional office and business relocation in Galanta. We minimize downtime by moving during weekends and holidays.",
      ...
      },
      {
        ...
        description:
          "Expert assembly and disassembly of any furniture during your move in Galanta. We save your time and energy.",
      ...
      },
      {
        ...
        description:
          "We specialize in moving heavy items such as pianos, safes, and large furniture pieces in Galanta.",
        link: "/en/moving-heavy-loads",
      },
      {
        image: "/icons/globe_icon.svg",
        title: "International Moving from Galanta",
        description:
          "Moving from Galanta abroad or vice versa. Complete solution for international relocation with minimum hassle.",
      ...
      },
      {
        ...
        description:
          "Complete property clearance services in Galanta. Ideal for property sales, renovations, or estate settlements.",
  ...
  const mapData = {
    title: "We Move Throughout Galanta",
    description:
      "Our services are available throughout Galanta and surrounding areas for complete home and business relocations.",
    locations: [
          "Galanta center",
          "Sereď",
          "Dolná Streda",
    ...
    additionalText: "Trnava, Senec, Dunajská Streda, and other surrounding towns.",
  };

  const faqData = {
    title: "Frequently Asked Questions About Moving in Galanta",
    items: [
      {
        question: "Which areas of Galanta do you cover?",
        answer:
          "We provide our services throughout Galanta and all surrounding towns and villages. Contact us for details about service in your specific location.",
      },
      {
        question: "What is the cost of moving in Galanta?",
        answer:
      ...
      {
        question: "How far in advance should I book a move in Galanta?",
        answer:
      ...
      {
        question: "Do you provide furniture assembly and disassembly in Galanta?",
        answer:
      ...
      {
        question: "Can you move heavy items like pianos or safes in Galanta?",
        answer:
    ...
    <main className="bg-white">
      ...
      <div>
        <CTA
          ...
          description="Let us handle your move in Galanta with professional care. Contact us today for a free quote."
