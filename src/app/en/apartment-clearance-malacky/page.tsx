...
export const metadata = {
  title: "Apartment & House Clearance Malacky | Sofoservis",
  description:
    "Professional apartment and house clearance services in Malacky ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance malacky, house clearance malacky, home clearance malacky, property clearance malacky",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-malacky",
    languages: {
...
export default function ApartmentClearanceMalackyPage() {
  const faqItems = [
    { question: "How does the apartment clearance process work in Malacky?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment clearance cost in Malacky?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange clearance in Malacky?", answer: "We can usually arrange clearance in Malacky within 1-3 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Clearance in Malacky"
          description="Professional apartment and house clearance services in Malacky. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Malacky and Surroundings"
          description="We provide professional clearance services in Malacky and nearby areas"
          locations={["Malacky","Stupava","Záhorská Ves","Plavecký Štvrtok","Gajary","Lozorno","Borinka"]}
          additionalText="We serve Malacky and surrounding towns in the Záhorie region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Malacky"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Malacky?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Malacky and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-malacky", icon: "/icons/truck_icon.svg" },
        ]}
      />
