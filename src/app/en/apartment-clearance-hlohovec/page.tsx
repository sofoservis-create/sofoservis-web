...
export const metadata = {
  title: "Apartment & House Clearance Hlohovec | Sofoservis",
  description:
    "Professional apartment and house clearance services in Hlohovec ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance hlohovec, house clearance hlohovec, home clearance hlohovec, property clearance hlohovec",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-hlohovec",
    languages: {
...
export default function ApartmentClearanceHlohovecPage() {
  const faqItems = [
    { question: "How does the apartment clearance process work in Hlohovec?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment clearance cost in Hlohovec?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange clearance in Hlohovec?", answer: "We can usually arrange clearance in Hlohovec within 2-4 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Clearance in Hlohovec"
          description="Professional apartment and house clearance services in Hlohovec. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Hlohovec and Surroundings"
          description="We provide professional clearance services in Hlohovec and nearby areas"
          locations={["Hlohovec","Trnava","Piešťany","Leopoldov","Šulekovo","Bojničky","Červeník"]}
          additionalText="We serve Hlohovec and surrounding towns in the Trnava region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Hlohovec"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Hlohovec?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Hlohovec and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-hlohovec", icon: "/icons/truck_icon.svg" },
        ]}
      />
