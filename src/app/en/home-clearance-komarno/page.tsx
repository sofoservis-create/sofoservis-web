...
export const metadata = {
  title: "Home Clearance Komárno | Sofoservis",
  description:
    "Professional home clearance services in Komárno ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance komarno, house clearance komarno, property clearance komarno, estate clearance komarno",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-komarno",
    languages: {
...
export default function HomeClearanceKomarnoPage() {
  const faqItems = [
    { question: "How does the clearance process work in Komárno?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Komárno?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Komárno?", answer: "We can typically arrange clearance in Komárno within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Clearance Services in Komárno"
          description="Professional and fast home clearance services in Komárno and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Clearance in Komárno and Surroundings"
          description="We provide professional services in Komárno and nearby locations"
          locations={nearbyTowns}
          additionalText="We serve the entire Komárno district and surrounding areas in southern Slovakia."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Komárno"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Komárno?"
          description="Let our experienced team handle everything - from sorting items to final space cleaning. We operate in all parts of Komárno."
