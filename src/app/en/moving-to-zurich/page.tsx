  ...
  return (
    <main className="bg-white">
      <Hero
        ...
        benefits={["Swiss customs handled", "2-4 day delivery", "Door-to-door to Zurich"]}
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Moving Bratislava to Zurich", description: "Dedicated Bratislava–Zurich route page.", href: "/en/moving-bratislava-zurich", icon: "/icons/truck_icon.svg" },
