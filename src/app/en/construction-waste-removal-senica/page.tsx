...
export default function ConstructionWasteRemovalSenicaPage() {
  const faqItems = [
            {
              question: "How much does construction waste removal cost in Senica?",
              answer:
            ...
            {
              question: "How quickly can you arrange waste removal in Senica?",
              answer:
  ...
  const heroData = {
    title: "Construction Waste Removal in Senica",
    description:
      "Professional and fast construction waste removal and ecological disposal services in Senica and surrounding areas. We handle waste from renovations, demolitions, or construction at competitive prices with complete disposal documentation.",
  ...
  return (
    <main className="bg-white">
      ...
      <div className="py-16">
        <LocationMap
          title="Construction Waste Removal Throughout Senica"
          description="We operate in all areas of Senica"
          locations={["Senica center","Sobotište","Kunov","Hlboké","Rovensko","Rybky","Prietrž","Častkov","Smrdáky","Rohov","Čáčov","Brezová pod Bradlom"]}
          additionalText="We also serve Skalica, Holíč, Myjava, and other surrounding towns."
      ...
      <div>
        <CTA
          title="Need construction waste removed in Senica?"
