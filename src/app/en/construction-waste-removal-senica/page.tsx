...
export default function ConstructionWasteRemovalSenicaPage() {
  ...
  const heroData = {
    ...
    description:
      "Professional and fast construction waste removal and ecological disposal services in Senica and surrounding areas. We handle waste from renovations.",
  ...
  const featuresData = {
    title: "Complete Construction Waste Removal Services in Senica",
    description:
