...
export const metadata = {
  title: "Home Clearance Nitra | Sofoservis",
  description:
    "Professional home clearance services in Nitra ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance nitra, house clearance nitra, property clearance nitra, estate clearance nitra",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-nitra",
    languages: {
      sk: "https://www.sofoservis.sk/vypratavanie-nitra",
      en: "https://www.sofoservis.sk/en/home-clearance-nitra",
      "x-default": "https://www.sofoservis.sk/vypratavanie-nitra",
    },
  },
};

export default function HomeClearanceNitraPage() {
  const faqItems = [
    { question: "How does the clearance process work in Nitra?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Nitra?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Nitra?", answer: "We can typically arrange clearance in Nitra within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Clearance Services in Nitra"
          description="Professional and fast home clearance services in Nitra and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Clearance in Nitra and Surroundings"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Nitra"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Nitra?"
