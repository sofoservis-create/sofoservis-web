...
export const metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: "https://www.sofoservis.sk/en/home-junk-removal-nove-mesto",
      "x-default": "https://www.sofoservis.sk/vypratavanie-nove-mesto",
    },
  },
};

export default function HomeJunkRemovalNoveMestoPage() {
  const faqItems = [
    { question: "How does the junk removal process work in Nové Mesto?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home junk removal in Nové Mesto?", answer: "The cost depends on space size, amount of items, accessibility (floor number, elevator), waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. We provide a free on-site quote." },
    { question: "How quickly can you arrange junk removal in Nové Mesto?", answer: "Being based in Bratislava, we can often arrange junk removal in Nové Mesto within 24-48 hours. Contact us for the earliest available term." },
    { question: "Do you handle junk removal in apartments and office spaces in Nové Mesto?", answer: "Yes, we handle junk removal for both residential properties and commercial/office spaces in Nové Mesto district." },
  ];
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Junk Removal Services in Nové Mesto"
          description="Professional and fast home junk removal services in Nové Mesto district of Bratislava. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Junk Removal in Nové Mesto District"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Junk Removal in Nové Mesto"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home junk removal in Nové Mesto?"
