...
export default function ConstructionWasteRemovalTrnavaPage() {
  const faqItems = [
            {
              question: "How much does construction waste removal cost in Trnava?",
              answer:
            ...
            {
              question: "How quickly can you arrange waste removal in Trnava?",
              answer:
  ...
  const heroData = {
    title: "Construction Waste Removal in Trnava",
    description:
      "Professional and fast construction waste removal and ecological disposal services in Trnava and surrounding areas. We handle waste from renovations, demolitions, or construction at competitive prices with complete disposal documentation.",
  ...
  return (
    <main className="bg-white">
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Construction Waste Removal in Trnava"
          items={[
            {
              question: "How much does construction waste removal cost in Trnava?",
              answer:
      ...
      <div>
        <CTA
          title="Need construction waste removed in Trnava?"
