...
export default function ConstructionWasteRemovalTrnavaPage() {
  ...
  const heroData = {
    ...
    description:
      "Professional and fast construction waste removal and ecological disposal services in Trnava and surrounding areas. We handle waste from renovations.",
  ...
  const featuresData = {
    title: "Complete Construction Waste Removal Services in Trnava",
    description:
