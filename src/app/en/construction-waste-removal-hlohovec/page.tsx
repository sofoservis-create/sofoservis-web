...
export default function ConstructionWasteRemovalHlohovecPage() {
  ...
  const heroData = {
    ...
    description:
      "Professional and fast construction waste removal and ecological disposal services in Hlohovec and surrounding areas. We handle waste from renovations.",
  ...
  const featuresData = {
    title: "Complete Construction Waste Removal Services in Hlohovec",
    description:
