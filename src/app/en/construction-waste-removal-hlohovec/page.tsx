...
export default function ConstructionWasteRemovalHlohovecPage() {
  const faqItems = [
            {
              question: "How much does construction waste removal cost in Hlohovec?",
              answer:
            ...
            {
              question: "How quickly can you arrange waste removal in Hlohovec?",
              answer:
  ...
  const heroData = {
    title: "Construction Waste Removal in Hlohovec",
    description:
      "Professional and fast construction waste removal and ecological disposal services in Hlohovec and surrounding areas. We handle waste from renovations, demolitions, or construction at competitive prices with complete disposal documentation.",
  ...
  return (
    <main className="bg-white">
      ...
      <div className="py-16">
        <LocationMap
          title="Construction Waste Removal Throughout Hlohovec"
          description="We operate in all areas of Hlohovec"
          locations={["Hlohovec center","Šulekovo","Peter","Dolné Trhovište","Pastuchov","Bojničky","Leopoldov","Červeník","Tepličky","Sasinkovo"]}
          additionalText="We also serve Trnava, Piešťany, Sereď, and other surrounding towns."
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Construction Waste Removal in Hlohovec"
          items={[
            {
              question: "How much does construction waste removal cost in Hlohovec?",
              answer:
      ...
      <div>
        <CTA
          title="Need construction waste removed in Hlohovec?"
