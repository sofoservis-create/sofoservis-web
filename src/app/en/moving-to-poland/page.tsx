  ...
  return (
    <main className="bg-white">
      <Hero
        ...
        benefits={["Warsaw, Kraków, Gdańsk", "1-2 day delivery to Poland", "Door-to-door service"]}
      ...
      <div><GoogleReviews showReviewsShowcase={false} title="Reviews from Customers Who Moved to Poland" /></div>
      <div>
        <FAQ
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Moving Bratislava to Warsaw", description: "Bratislava–Warsaw moving route.", href: "/en/moving-bratislava-warsaw", icon: "/icons/truck_icon.svg" },
