...
export const metadata = {
  title: "Wall & Partition Demolition Services | Sofoservis",
  description:
...
export default function WallDemolitionPageEN() {
  ...
  const heroData = {
    ...
    description:
      "Professional services for demolishing and removing load-bearing walls, non-load-bearing partitions, and creating openings in walls.",
