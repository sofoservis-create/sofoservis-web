...
export const metadata = {
  title: "Home Clearance Šaľa | Sofoservis",
  description:
    "Professional home clearance services in Šaľa ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance sala, house clearance sala, property clearance sala, estate clearance sala",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-sala",
    languages: {
...
export default function HomeClearanceSalaPage() {
  const faqItems = [
    { question: "How does the clearance process work in Šaľa?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Šaľa?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Šaľa?", answer: "We can typically arrange clearance in Šaľa within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Clearance Services in Šaľa"
          description="Professional and fast home clearance services in Šaľa and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
          formTitle="Get a free price quote"
          formSubtitle="Fill out the form for a no-obligation estimate in Šaľa"
      ...
      <div>
        <LocationMap
          title="Home Clearance in Šaľa and Surroundings"
          description="We provide professional services in Šaľa and nearby locations"
          locations={nearbyTowns}
          additionalText="We serve the entire Šaľa district and surrounding areas in the Nitra region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Šaľa"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Šaľa?"
          description="Let our experienced team handle everything - from sorting items to final space cleaning. We operate in all parts of Šaľa."
