...
export const metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: "https://www.sofoservis.sk/en/home-junk-removal-petrzalka",
      "x-default": "https://www.sofoservis.sk/vypratavanie-petrzalka",
    },
  },
};

export default function HomeJunkRemovalPetrzalkaPage() {
  const faqItems = [
    { question: "How does the junk removal process work in Petržalka?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home junk removal in Petržalka?", answer: "The cost depends on space size, amount of items, accessibility (floor number, elevator), waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. We provide a free on-site quote." },
    { question: "How quickly can you arrange junk removal in Petržalka?", answer: "Being based in Bratislava, we can often arrange junk removal in Petržalka within 24-48 hours. Contact us for the earliest available term." },
    { question: "Do you handle junk removal in panel blocks in Petržalka?", answer: "Yes, we have extensive experience with junk removal in Petržalka's residential panel blocks, including handling high floors and elevator access." },
  ];
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Junk Removal Services in Petržalka"
          description="Professional and fast home junk removal services in Petržalka district of Bratislava. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Junk Removal in Petržalka District"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Junk Removal in Petržalka"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home junk removal in Petržalka?"
