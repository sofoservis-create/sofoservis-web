...
export const metadata = {
  title: "Apartment & House Clearance Bratislava | Sofoservis",
  description:
    "Professional apartment and house clearance services in Bratislava ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance bratislava, house clearance bratislava, home clearance bratislava, property clearance bratislava",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-bratislava",
    languages: {
...
export default function ApartmentClearanceBratislavaPage() {
  const faqItems = [
    { question: "How does the apartment clearance process work in Bratislava?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment clearance cost in Bratislava?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange clearance in Bratislava?", answer: "Since we are based in Bratislava, we can arrange clearance quickly. In urgent cases, within 24-48 hours." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Clearance in Bratislava"
          description="Professional apartment and house clearance services in Bratislava. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Bratislava and Surroundings"
          description="We provide professional clearance services in Bratislava and nearby areas"
          locations={["Petržalka","Ružinov","Nové Mesto","Staré Mesto","Karlova Ves","Dúbravka"]}
          additionalText="We cover all city districts and nearby towns including Senec, Pezinok, and Malacky."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Bratislava"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Bratislava?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Bratislava and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-bratislava", icon: "/icons/truck_icon.svg" },
        ]}
      />
