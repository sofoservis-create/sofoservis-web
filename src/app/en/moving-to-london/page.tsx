  ...
  return (
    <main className="bg-white">
      <Hero
        ...
        benefits={["Post-Brexit customs handled", "4-7 day delivery", "Door-to-door to London"]}
      ...
      <div><GoogleReviews showReviewsShowcase={false} title="Reviews from Customers Who Moved to London" /></div>
      <div>
        <FAQ
