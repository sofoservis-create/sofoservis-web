...
export const metadata = {
  title: "Home Junk Removal Senica | Sofoservis",
  description:
    "Professional home junk removal services in Senica ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home junk removal senica, house junk removal senica, property junk removal senica, estate junk removal senica",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-junk-removal-senica",
    languages: {
      sk: "https://www.sofoservis.sk/vypratavanie-senica",
      en: "https://www.sofoservis.sk/en/home-junk-removal-senica",
      "x-default": "https://www.sofoservis.sk/vypratavanie-senica",
    },
  },
};

export default function HomeJunkRemovalSenicaPage() {
  const faqItems = [
    { question: "How does the junk removal process work in Senica?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home junk removal in Senica?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange junk removal in Senica?", answer: "We can usually arrange junk removal within 2-5 working days. In urgent cases, we try to accommodate your schedule and arrive even sooner. Contact us for availability." },
    { question: "Where do you take the waste from junk removal in Senica?", answer: "We transport waste to official collection yards and landfills in compliance with waste management regulations. Recyclable materials go to recycling facilities, hazardous waste to specialized disposal facilities." },
  ];

  const cityIntro =
    "Senica is a town in the north-western Záhorie region of Slovakia with characteristic older family homes and smaller apartment buildings. Junk Removal in Senica typically involves the large cellars and garden outbuildings typical of traditional Záhorie-style homes, alongside standard flat junkRemovals.";
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Junk Removal Services in Senica"
          description="Professional and fast home junk removal services in Senica and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Junk Removal in Senica and Surroundings"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Junk Removal in Senica"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home junk removal in Senica?"
