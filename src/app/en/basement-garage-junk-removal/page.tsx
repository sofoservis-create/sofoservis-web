  ...
  return (
    <main className="bg-white">
      ...
      <RelatedServices
          ...
          services={[{"title":"Basement & Garage Clearance","description":"Professional basement and garage cleanouts.","href":"/en/basement-garage-clearance","icon":"/icons/house_icon.svg"},{"title":"Old Furniture Removal","description":"Fast pickup and eco-friendly disposal of old furniture.","href":"/en/furniture-removal","icon":"/icons/truck_icon.svg"},{"title":"Construction Waste Removal","description":"Quick removal of construction debris, rubble and building waste.","href":"/en/construction-waste-removal","icon":"/icons/recycle_icon.svg"},{"title":"Home Clearance","description":"Complete home clearance — we remove everything you no longer need.","href":"/en/home-clearance","icon":"/icons/broom_icon.svg"}]}
        />
