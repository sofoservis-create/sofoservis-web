...
export const metadata = {
  title: "Moving Services Malacky - Apartments, Houses & Offices | Sofoservis",
  description:
...
export default function MovingMalackyPage() {
  const heroData = {
    ...
    description:
      "Complete moving services in Malacky and surrounding areas. Professional team, competitive prices, satisfaction guaranteed. We move apartments, houses, offices, and businesses throughout Malacky.",
