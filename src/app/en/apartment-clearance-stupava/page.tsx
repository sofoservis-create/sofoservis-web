...
export const metadata = {
  title: "Apartment & House Clearance Stupava | Sofoservis",
  description:
    "Professional apartment and house clearance services in Stupava ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance stupava, house clearance stupava, home clearance stupava, property clearance stupava",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-stupava",
    languages: {
...
export default function ApartmentClearanceStupavaPage() {
  const faqItems = [
    { question: "How does the apartment clearance process work in Stupava?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment clearance cost in Stupava?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange clearance in Stupava?", answer: "We can usually arrange clearance in Stupava within 1-3 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Clearance in Stupava"
          description="Professional apartment and house clearance services in Stupava. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Stupava and Surroundings"
          description="We provide professional clearance services in Stupava and nearby areas"
          locations={["Stupava","Malacky","Zohor","Lozorno","Záhorská Bystrica","Devínska Nová Ves"]}
          additionalText="We serve Stupava and surrounding towns in the Bratislava region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Stupava"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Stupava?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Stupava and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-stupava", icon: "/icons/truck_icon.svg" },
        ]}
      />
