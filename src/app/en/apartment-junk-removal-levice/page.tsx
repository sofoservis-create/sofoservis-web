...
export const metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: "https://www.sofoservis.sk/en/apartment-junk-removal-levice",
      "x-default": "https://www.sofoservis.sk/vypratavanie-bytov-domov/levice",
    },
  },
};

export default function ApartmentJunkRemovalLevicePage() {
  const faqItems = [
    { question: "How does the apartment junk removal process work in Levice?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment junk removal cost in Levice?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange junk removal in Levice?", answer: "We can usually arrange junk removal in Levice within 2-4 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Junk Removal in Levice"
          description="Professional apartment and house junk removal services in Levice. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Junk Removal in Levice and Surroundings"
          description="We provide professional junk removal services in Levice and nearby areas"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Junk Removal in Levice"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment junk removal in Levice?"
