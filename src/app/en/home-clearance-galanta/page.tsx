...
export const metadata = {
  title: "Home Clearance Galanta | Sofoservis",
  description:
    "Professional home clearance services in Galanta ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance galanta, house clearance galanta, property clearance galanta, estate clearance galanta",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-galanta",
    languages: {
...
export default function HomeClearanceGalantaPage() {
  const faqItems = [
    { question: "How does the clearance process work in Galanta?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Galanta?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Galanta?", answer: "We can typically arrange clearance in Galanta within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  const cityIntro =
    "Galanta is a district town in the Trnava Region with many Soviet-era panel apartment buildings and older family homes in the surrounding area. Our clearance teams in Galanta regularly handle basements in panel blocks, large cellars typical for the region, and family homes being prepared for sale. We cover the entire Galanta district and surrounding municipalities.";
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Clearance Services in Galanta"
          description="Professional and fast home clearance services in Galanta and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
          formTitle="Get a free price quote"
          formSubtitle="Fill out the form for a no-obligation estimate in Galanta"
      ...
      <div>
        <LocationMap
          title="Home Clearance in Galanta and Surroundings"
          description="We provide professional services in Galanta and nearby locations"
          locations={nearbyTowns}
          additionalText="We serve the entire Galanta district and surrounding areas in the Trnava region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Galanta"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Galanta?"
          description="Let our experienced team handle everything - from sorting items to final space cleaning. We operate in all parts of Galanta."
