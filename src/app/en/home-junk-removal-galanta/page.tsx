...
export const metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: "https://www.sofoservis.sk/en/home-junk-removal-galanta",
      "x-default": "https://www.sofoservis.sk/vypratavanie-galanta",
    },
  },
};

export default function HomeJunkRemovalGalantaPage() {
  const faqItems = [
    { question: "How does the junk removal process work in Galanta?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home junk removal in Galanta?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange junk removal in Galanta?", answer: "We can typically arrange junk removal in Galanta within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Junk Removal Services in Galanta"
          description="Professional and fast home junk removal services in Galanta and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Junk Removal in Galanta and Surroundings"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Junk Removal in Galanta"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home junk removal in Galanta?"
