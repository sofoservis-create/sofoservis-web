...
export const metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: "https://www.sofoservis.sk/en/home-junk-removal-senec",
      "x-default": "https://www.sofoservis.sk/vypratavanie-senec",
    },
  },
};

export default function HomeJunkRemovalSenecPage() {
  const faqItems = [
    { question: "How does the junk removal process work in Senec?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home junk removal in Senec?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange junk removal in Senec?", answer: "We can usually arrange junk removal within 2-5 working days. In urgent cases, we try to accommodate your schedule and arrive even sooner. Contact us for availability." },
    { question: "Where do you take the waste from junk removal in Senec?", answer: "We transport waste to official collection yards and landfills in compliance with waste management regulations. Recyclable materials go to recycling facilities, hazardous waste to specialized disposal facilities." },
  ];

  const cityIntro =
    "Senec is one of the most popular towns near Bratislava, known for its Sunny Lakes and diverse property types — from holiday cottages to modern housing estates. The town's proximity to the capital means properties change hands frequently, with professional junk removal often required before each sale or renovation.";
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Junk Removal Services in Senec"
          description="Professional and fast home junk removal services in Senec and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Junk Removal in Senec and Surroundings"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Junk Removal in Senec"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home junk removal in Senec?"
