...
export const metadata = {
  title: "Moving Services Hlohovec - Apartments, Houses & Offices | Sofoservis",
  description:
  ...
  alternates: {
    ...
    languages: {
      sk: "https://www.sofoservis.sk/stahovanie-hlohovec",
      en: "https://www.sofoservis.sk/en/moving-hlohovec",
      "x-default": "https://www.sofoservis.sk/stahovanie-hlohovec",
      },
  },
};

export default function MovingHlohovecPage() {
  const heroData = {
    title: "Moving Services in Hlohovec",
    description:
      "Complete moving services in Hlohovec and surrounding areas. Professional team, competitive prices, satisfaction guaranteed. We move apartments, houses, offices, and businesses throughout Hlohovec.",
    formTitle: "Hassle-free moving in Hlohovec with a free quote",
    formSubtitle: "Fill out the form below for a quick fixed price",
    backgroundImage: "/images/stahovanie_gauc.jpg",
  };

  const featuresData = {
    title: "Professional Moving Services in Hlohovec",
    description:
      "Complete moving solutions for homes and businesses in Hlohovec and surrounding areas.",
    features: [
      {
        image: "/icons/house_icon.svg",
        title: "Apartment & House Moving in Hlohovec",
        description:
          "Complete apartment and house moving services in Hlohovec. We safely transport your furniture and personal belongings to your new home.",
      ...
      },
      {
        ...
        description:
          "Professional office and business relocation in Hlohovec. We minimize downtime by moving during weekends and holidays.",
      ...
      },
      {
        ...
        description:
          "Expert assembly and disassembly of any furniture during your move in Hlohovec. We save your time and energy.",
      ...
      },
      {
        ...
        description:
          "We specialize in moving heavy items such as pianos, safes, and large furniture pieces in Hlohovec.",
        link: "/en/moving-heavy-loads",
      },
      {
        image: "/icons/globe_icon.svg",
        title: "International Moving from Hlohovec",
        description:
          "Moving from Hlohovec abroad or vice versa. Complete solution for international relocation with minimum hassle.",
      ...
      },
      {
        ...
        description:
          "Complete property clearance services in Hlohovec. Ideal for property sales, renovations, or estate settlements.",
  ...
  const mapData = {
    title: "We Move Throughout Hlohovec",
    description:
      "Our services are available throughout Hlohovec and surrounding areas for complete home and business relocations.",
    locations: [
          "Hlohovec center",
          "Šulekovo",
          "Peter",
    ...
    additionalText: "Trnava, Piešťany, Sereď, and other surrounding towns.",
  };

  const faqData = {
    title: "Frequently Asked Questions About Moving in Hlohovec",
    items: [
      {
        question: "Which areas of Hlohovec do you cover?",
        answer:
          "We provide our services throughout Hlohovec and all surrounding towns and villages. Contact us for details about service in your specific location.",
      },
      {
        question: "What is the cost of moving in Hlohovec?",
        answer:
      ...
      {
        question: "How far in advance should I book a move in Hlohovec?",
        answer:
      ...
      {
        question: "Do you provide furniture assembly and disassembly in Hlohovec?",
        answer:
      ...
      {
        question: "Can you move heavy items like pianos or safes in Hlohovec?",
        answer:
    ...
    <main className="bg-white">
      ...
      <div>
        <CTA
          ...
          description="Let us handle your move in Hlohovec with professional care. Contact us today for a free quote."
