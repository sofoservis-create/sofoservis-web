...
export const metadata = {
  title: "Moving Services Pezinok | Sofoservis",
  description:
...
export default function MovingPezinokPage() {
  const heroData = {
    ...
    description:
      "Complete moving services in Pezinok and surrounding areas. Professional team, competitive prices, satisfaction guaranteed. We move apartments, houses.",
