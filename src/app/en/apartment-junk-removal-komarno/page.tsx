...
export const metadata = {
  title: "Apartment & House Junk Removal Komárno | Sofoservis",
  description:
    "Professional apartment and house junk removal services in Komárno ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment junk removal komárno, house junk removal komárno, home junk removal komárno, property junk removal komárno",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-junk-removal-komarno",
    languages: {
      sk: "https://www.sofoservis.sk/vypratavanie-bytov-domov/komarno",
      en: "https://www.sofoservis.sk/en/apartment-junk-removal-komarno",
      "x-default": "https://www.sofoservis.sk/vypratavanie-bytov-domov/komarno",
    },
  },
};

export default function ApartmentJunkRemovalKomarnoPage() {
  const faqItems = [
    { question: "How does the apartment junk removal process work in Komárno?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment junk removal cost in Komárno?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange junk removal in Komárno?", answer: "We can usually arrange junk removal in Komárno within 2-4 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Junk Removal in Komárno"
          description="Professional apartment and house junk removal services in Komárno. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Junk Removal in Komárno and Surroundings"
          description="We provide professional junk removal services in Komárno and nearby areas"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Junk Removal in Komárno"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment junk removal in Komárno?"
