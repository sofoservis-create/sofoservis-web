...
export const metadata = {
  title: "Apartment & House Clearance Šamorín | Sofoservis",
  description:
    "Professional apartment and house clearance services in Šamorín ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance šamorín, house clearance šamorín, home clearance šamorín, property clearance šamorín",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-samorin",
    languages: {
...
export default function ApartmentClearanceSamorinPage() {
  const faqItems = [
    { question: "How does the apartment clearance process work in Šamorín?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment clearance cost in Šamorín?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange clearance in Šamorín?", answer: "We can usually arrange clearance in Šamorín within 1-3 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Clearance in Šamorín"
          description="Professional apartment and house clearance services in Šamorín. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Šamorín and Surroundings"
          description="We provide professional clearance services in Šamorín and nearby areas"
          locations={["Šamorín","Dunajská Streda","Senec","Bratislava","Ivanka pri Dunaji","Rovinka"]}
          additionalText="We serve Šamorín and surrounding towns in the Bratislava region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Šamorín"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Šamorín?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Šamorín and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-samorin", icon: "/icons/truck_icon.svg" },
        ]}
      />
