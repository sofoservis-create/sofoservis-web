...
export const metadata = {
  title: "Property Property Property & Land Junk Removal Land Junk Removal Services Land Junk Removal Services | Sofoservis",
  description:
  ...
  openGraph: {
    title: "Property Property Property & Land Junk Removal Land Junk Removal Services Land Junk Removal Services | Sofoservis",
    description:
      "Professional property and land junk removal with eco-friendly disposal. Prepare your land for construction or sale!",
...
export default function PropertyLandJunkRemovalPage() {
  const faqItems = [
            {
              question: "How does the property junk removal process work?",
              answer:
            ...
            {
              question: "What is the price for land junk removal?",
              answer:
            ...
            {
              question: "What permits are needed for land junk removal?",
              answer:
                "Required permits depend on the location and scope of work. For regular junk removal of private land from overgrown vegetation and waste, special permits are usually not needed. However, if there are mature trees with trunk circumference over 40 cm, you may need a permit from the environmental authority. For properties in protected areas, additional permits may be required.",
            },
            {
              question:
                "How long does it take to clear a standard property?",
              answer:
                "Junk Removal time depends on the property size and condition. A smaller property (up to 500m²) with normal contamination can be cleared in 1-2 working days. Medium properties (500-2000m²) usually require 2-5 days. For larger properties or heavily overgrown areas, junk removal may take a week or more.",
            },
            {
  ...
  const featuresData = {
    title: "Comprehensive Property Property Property & Land Junk Removal Land Junk Removal Services Land Junk Removal Services",
    description:
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Complete junk removal of properties before sale or renovation. We clean all spaces and prepare them for further use.",
  ...
  return (
    <main className="bg-white">
      <Hero
        title="Property Property Property & Land Junk Removal Land Junk Removal Services Land Junk Removal Services"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Property Property & Land Junk Removal Land Junk Removal"
          items={[
            {
              question: "How does the property junk removal process work?",
              answer:
          ...
          callToActionText="Questions about land junk removal? Get in touch"
        />
      </div>
      ...
      <div>
        <CTA
          ...
          description="Transform a neglected property into a valuable space for construction, gardening, or sale. Our team handles complete junk removal, vegetation removal, and eco-friendly disposal of all waste. Get a quote today!"
      ...
      <RelatedServices
          ...
          services={[{"title":"Property & Land Clearance","description":"Full clearance of properties, land and overgrown areas.","href":"/en/property-land-clearance","icon":"/icons/landscape_icon.svg"},{"title":"Construction Waste Removal","description":"Quick removal of construction debris, rubble and building waste.","href":"/en/construction-waste-removal","icon":"/icons/recycle_icon.svg"},{"title":"Hazardous Waste Removal","description":"Safe and legal disposal of hazardous materials and old appliances.","href":"/en/hazardous-waste-removal","icon":"/icons/hazmat_icon.svg"},{"title":"Home Clearance","description":"Complete home clearance — we remove everything you no longer need.","href":"/en/home-clearance","icon":"/icons/broom_icon.svg"}]}
        />
