...
export default function PropertyLandJunkRemovalPage() {
  ...
  const featuresData = {
    title: "Complete Property & Land Junk Removal Services",
    description:
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Property & Land Junk Removal Services"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Property & Land Junk Removal"
          items={[
            {
              question: "How does the property junk removal process work?",
              answer:
