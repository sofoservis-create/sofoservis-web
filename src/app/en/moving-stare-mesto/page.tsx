    ...
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Home Clearance", description: "Property clearance in Staré Mesto from €25/hour.", href: "/en/home-junk-removal-stare-mesto", icon: "/icons/vypratavanie_icon.svg" },
