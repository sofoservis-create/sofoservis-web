...
export const metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: "https://www.sofoservis.sk/en/home-junk-removal-malacky",
      "x-default": "https://www.sofoservis.sk/vypratavanie-malacky",
    },
  },
};

export default function HomeJunkRemovalMalackyPage() {
  const faqItems = [
    { question: "How does the junk removal process work in Malacky?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home junk removal in Malacky?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange junk removal in Malacky?", answer: "We can typically arrange junk removal in Malacky within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  const cityIntro =
    "Malacky is a fast-growing town in the Záhorie region close to Bratislava. The mix of older family homes, new developments, and apartment buildings creates diverse junk removal needs — from small basement storage rooms to full family houses being prepared for sale or renovation.";
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Junk Removal Services in Malacky"
          description="Professional and fast home junk removal services in Malacky and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Junk Removal in Malacky and Surroundings"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Junk Removal in Malacky"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home junk removal in Malacky?"
