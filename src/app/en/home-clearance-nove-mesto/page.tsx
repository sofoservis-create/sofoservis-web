...
export const metadata = {
  title: "Home Clearance Nové Mesto Bratislava | Sofoservis",
  description:
    "Professional home clearance services in Nové Mesto, Bratislava ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance nové mesto, house clearance nové mesto, property clearance nové mesto, estate clearance nové mesto",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-nove-mesto",
    languages: {
...
export default function HomeClearanceNoveMestoPage() {
  const faqItems = [
    { question: "How does the clearance process work in Nové Mesto?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Nové Mesto?", answer: "The cost depends on space size, amount of items, accessibility (floor number, elevator), waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Nové Mesto?", answer: "Being based in Bratislava, we can often arrange clearance in Nové Mesto within 24-48 hours. Contact us for the earliest available term." },
    { question: "Do you handle clearance in apartments and office spaces in Nové Mesto?", answer: "Yes, we handle clearance for both residential properties and commercial/office spaces in Nové Mesto district." },
  ];

  return (
    <main className="bg-white">
      <Hero
        title="Home Clearance Services in Nové Mesto"
        description="Professional and fast home clearance services in Nové Mesto district of Bratislava. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
        formTitle="Get a free price quote"
        formSubtitle="Fill out the form for a no-obligation estimate in Nové Mesto"
      ...
      <div>
        <LocationMap
          title="Home Clearance in Nové Mesto District"
          description="We provide professional services in Nové Mesto and surrounding Bratislava districts"
          locations={["Nové Mesto", "Rača", "Staré Mesto", "Ružinov", "Vajnory", "Kramáre", "Koliba"]}
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Nové Mesto"
          items={faqItems}
        />
      </div>
