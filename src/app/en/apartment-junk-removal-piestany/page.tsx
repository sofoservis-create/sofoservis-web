...
export const metadata = {
  title: "Apartment & House Junk Removal Piešťany | Sofoservis",
  description:
    "Professional apartment and house junk removal services in Piešťany ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment junk removal piešťany, house junk removal piešťany, home junk removal piešťany, property junk removal piešťany",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-junk-removal-piestany",
    languages: {
      sk: "https://www.sofoservis.sk/vypratavanie-bytov-domov/piestany",
      en: "https://www.sofoservis.sk/en/apartment-junk-removal-piestany",
      "x-default": "https://www.sofoservis.sk/vypratavanie-bytov-domov/piestany",
    },
  },
};

export default function ApartmentJunkRemovalPiestanyPage() {
  const faqItems = [
    { question: "How does the apartment junk removal process work in Piešťany?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment junk removal cost in Piešťany?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange junk removal in Piešťany?", answer: "We can usually arrange junk removal in Piešťany within 2-4 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Junk Removal in Piešťany"
          description="Professional apartment and house junk removal services in Piešťany. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Junk Removal in Piešťany"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment junk removal in Piešťany?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Piešťany and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-piestany", icon: "/icons/truck_icon.svg" },
        ]}
      />
