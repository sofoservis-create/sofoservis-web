...
export const metadata = {
  title: "Home Clearance Trnava | Sofoservis",
  description:
    "Professional home clearance services in Trnava ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance trnava, house clearance trnava, property clearance trnava, estate clearance trnava",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-trnava",
    languages: {
...
export default function HomeClearanceTrnavaPage() {
  const faqItems = [
    { question: "How does the clearance process work in Trnava?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Trnava?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Trnava?", answer: "We can usually arrange clearance within 2-5 working days. In urgent cases, we try to accommodate your schedule and arrive even sooner. Contact us for availability." },
    { question: "Where do you take the waste from clearance in Trnava?", answer: "We transport waste to official collection yards and landfills in compliance with waste management regulations. Recyclable materials go to recycling facilities, hazardous waste to specialized disposal facilities." },
  ];

  const cityIntro =
    "Trnava is a regional capital with medieval origins, featuring a well-preserved historic centre alongside large Soviet-era housing estates. Clearance needs range from the spacious cellars under historic town buildings to panel-block flats on upper floors — our team is experienced with all property types in Trnava.";
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Clearance Services in Trnava"
          description="Professional and fast home clearance services in Trnava and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Clearance in Trnava and Surroundings"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Trnava"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Trnava?"
