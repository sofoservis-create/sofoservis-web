...
export const metadata = {
  title: "Moving Services Šamorín - Apartments, Houses & Offices | Sofoservis",
  description:
...
export default function MovingSamorinPage() {
  const heroData = {
    ...
    description:
      "Complete moving services in Šamorín and surrounding areas. Professional team, competitive prices, satisfaction guaranteed. We move apartments, houses, offices, and businesses throughout Šamorín.",
