...
export const metadata = {
  title: "Apartment & House Junk Removal Šaľa | Sofoservis",
  description:
    "Professional apartment and house junk removal services in Šaľa ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment junk removal šaľa, house junk removal šaľa, home junk removal šaľa, property junk removal šaľa",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-junk-removal-sala",
    languages: {
      sk: "https://www.sofoservis.sk/vypratavanie-bytov-domov/sala",
      en: "https://www.sofoservis.sk/en/apartment-junk-removal-sala",
      "x-default": "https://www.sofoservis.sk/vypratavanie-bytov-domov/sala",
    },
  },
};

export default function ApartmentJunkRemovalSalaPage() {
  const faqItems = [
    { question: "How does the apartment junk removal process work in Šaľa?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment junk removal cost in Šaľa?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange junk removal in Šaľa?", answer: "We can usually arrange junk removal in Šaľa within 2-4 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Junk Removal in Šaľa"
          description="Professional apartment and house junk removal services in Šaľa. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Junk Removal in Šaľa and Surroundings"
          description="We provide professional junk removal services in Šaľa and nearby areas"
          locations={["Šaľa","Galanta","Nitra","Diakovce","Vlčany","Tešedíkovo","Šoporňa"]}
          additionalText="We serve Šaľa and surrounding towns in the Nitra region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Junk Removal in Šaľa"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment junk removal in Šaľa?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Šaľa and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-sala", icon: "/icons/truck_icon.svg" },
        ]}
      />
