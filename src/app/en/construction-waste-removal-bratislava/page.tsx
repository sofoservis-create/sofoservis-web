...
export default function ConstructionWasteRemovalBratislavaPage() {
  const faqItems = [
            {
              question: "How much does construction waste removal cost in Bratislava?",
              answer:
            ...
            {
              question: "How quickly can you arrange waste removal in Bratislava?",
              answer:
  ...
  const heroData = {
    title: "Construction Waste Removal in Bratislava",
    description:
      "Professional and fast construction waste removal and ecological disposal services in Bratislava and surrounding areas. We handle waste from renovations, demolitions, or construction at competitive prices with complete disposal documentation.",
  ...
  const featuresData = {
    title: "Complete Construction Waste Removal Services",
    description:
  ...
  return (
    <main className="bg-white">
      ...
      <div className="py-16">
        <LocationMap
          title="Construction Waste Removal Throughout Bratislava"
          description="We operate in all areas of Bratislava"
          locations={["Staré Mesto","Ružinov","Vrakuňa","Podunajské Biskupice","Nové Mesto","Rača","Vajnory","Karlova Ves","Dúbravka","Lamač","Devín","Devínska Nová Ves","Záhorská Bystrica","Petržalka","Jarovce","Rusovce","Čunovo"]}
          additionalText="We also serve surrounding areas including Stupava, Svätý Jur, Pezinok, Senec, Šamorín, and more."
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Construction Waste Removal in Bratislava"
          items={[
            {
              question: "How much does construction waste removal cost in Bratislava?",
              answer:
      ...
      <div>
        <CTA
          title="Need construction waste removed in Bratislava?"
