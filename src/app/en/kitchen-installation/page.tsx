    ...
    features: [
      {
        ...
        description:
          "Complete kitchen unit installation including cabinets, worktops, sink, and all components. Precise installation according to the supplied plan with a functional result.",
