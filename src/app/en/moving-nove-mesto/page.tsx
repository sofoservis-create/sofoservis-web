...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Our rates start from €35/hour per worker. A standard move within Nové Mesto or to other parts of Bratislava starts from €60. For a precise estimate, please fill out our contact form.",
  },
  {
    ...
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Home Clearance", description: "Property clearance in Nové Mesto from €35/hour.", href: "/en/home-junk-removal-nove-mesto", icon: "/icons/vypratavanie_icon.svg" },
