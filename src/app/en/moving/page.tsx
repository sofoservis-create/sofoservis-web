...
export const metadata = {
  ...
  description:
    "Professional moving services for apartments, houses, offices and international relocations from €35/hr. Free site inspection. Fast, reliable.",
  alternates: {
  ...
  openGraph: {
    title: "Moving Services - Professional & Affordable | Sofoservis",
    description:
      "Professional moving services for apartments, houses, offices and international relocations from €35/hr. Free inspection. Fast, reliable.",
...
const faqSchemaItems = [
  {
    ...
    answer:
      "The hourly rate for 2 workers is €70/hr. For a 2-bedroom apartment in Bratislava the typical price is €200–€350. The final cost depends on distance, floor level, volume of belongings and whether furniture disassembly is needed.",
  },
  {
          ...
          items={[
            {
              ...
              answer:
                "The hourly rate for 2 workers is €70/hr. For a 2-bedroom apartment in Bratislava the typical price is €200–€350, for a 3–4 bedroom apartment €350–€600. Family houses are priced individually. We always provide a clear, fixed quote upfront.",
            },
            {
