  ...
  return (
    <main className="bg-white">
      <Hero
        ...
        description="Professional moving services for households and businesses. We move apartments, houses, offices, pianos, safes, machinery and heavy loads — quickly, safely and at fair prices."
        formTitle="Get a free price quote"
        formSubtitle="Fill out the form for a no-obligation estimate"
        backgroundImage="/images/stahovanie-gauc.avif"
        benefits={["Furniture insurance included", "No hidden fees", "Fixed price guaranteed"]}
        lang="en"
