...
export const metadata = {
  title: "Apartment & House Clearance Pezinok | Sofoservis",
  description:
    "Professional apartment and house clearance services in Pezinok ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance pezinok, house clearance pezinok, home clearance pezinok, property clearance pezinok",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-pezinok",
    languages: {
...
export default function ApartmentClearancePezinokPage() {
  const faqItems = [
    { question: "How does the apartment clearance process work in Pezinok?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment clearance cost in Pezinok?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange clearance in Pezinok?", answer: "We can usually arrange clearance in Pezinok within 1-3 working days." },
  ...
  return (
    <main className="bg-white">
      <Hero
        title="Apartment & House Clearance in Pezinok"
        description="Professional apartment and house clearance services in Pezinok. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Pezinok and Surroundings"
          description="We provide professional clearance services in Pezinok and nearby areas"
          locations={["Pezinok","Modra","Svätý Jur","Senec","Vinosady","Cajla","Šenkvice"]}
          additionalText="We serve Pezinok and surrounding towns in the Bratislava region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Pezinok"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Pezinok?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Pezinok and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-pezinok", icon: "/icons/truck_icon.svg" },
        ]}
      />
