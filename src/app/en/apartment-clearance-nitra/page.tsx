...
export const metadata = {
  title: "Apartment & House Clearance Nitra | Sofoservis",
  description:
    "Professional apartment and house clearance services in Nitra ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance nitra, house clearance nitra, home clearance nitra, property clearance nitra",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-nitra",
    languages: {
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Clearance in Nitra"
          description="Professional apartment and house clearance services in Nitra. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Nitra and Surroundings"
          description="We provide professional clearance services in Nitra and nearby areas"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Nitra"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Nitra?"
