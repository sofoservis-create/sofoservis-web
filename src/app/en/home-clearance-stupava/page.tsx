...
export const metadata = {
  title: "Home Clearance Stupava | Sofoservis",
  description:
    "Professional home clearance services in Stupava ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance stupava, house clearance stupava, property clearance stupava, estate clearance stupava",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-stupava",
    languages: {
...
export default function HomeClearanceStupavaPage() {
  const faqItems = [
    { question: "How does the clearance process work in Stupava?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Stupava?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Stupava?", answer: "We can usually arrange clearance within 2-5 working days. In urgent cases, we try to accommodate your schedule and arrive even sooner. Contact us for availability." },
    { question: "Where do you take the waste from clearance in Stupava?", answer: "We transport waste to official collection yards and landfills in compliance with waste management regulations. Recyclable materials go to recycling facilities, hazardous waste to specialized disposal facilities." },
  ];
  ...
  return (
    <main className="bg-white">
      <Hero
        title="Home Clearance Services in Stupava"
        description="Professional and fast home clearance services in Stupava and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Clearance in Stupava and Surroundings"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Stupava"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Stupava?"
