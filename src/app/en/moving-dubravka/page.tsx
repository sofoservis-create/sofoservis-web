...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Moving in Dúbravka starts from €35/hour per worker. Three workers cost €90/hour. Moving within Bratislava starts from €60. Fill out the form for a free estimate.",
  },
  {
    ...
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Home Clearance", description: "Property clearance in Dúbravka from €35/hour.", href: "/en/home-junk-removal-dubravka", icon: "/icons/vypratavanie_icon.svg" },
