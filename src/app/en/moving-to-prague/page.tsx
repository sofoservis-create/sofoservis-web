  ...
  return (
    <main className="bg-white">
      <Hero
        ...
        benefits={["1-2 day delivery to Prague", "Door-to-door service", "Fully insured"]}
      ...
      <div><GoogleReviews showReviewsShowcase={false} title="Reviews from Customers Who Moved to Prague" /></div>
      <div>
        <FAQ
