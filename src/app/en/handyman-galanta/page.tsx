...
export default function HandymanGalantaPage() {
  const heroData = {
    title: "Handyman Services in Galanta",
    description:
      "Professional handyman services in Galanta and surrounding areas for quick and reliable repairs, assembly, and home maintenance. We cover all of Galanta and nearby towns.",
    formTitle: "Get a free price quote",
    formSubtitle: "The fastest handyman in Galanta - fill out the form for a no-obligation estimate",
    backgroundImage: "/images/stahovanie_gauc.jpg",
  };

  const featuresData = {
    title: "Complete Handyman Services in Galanta",
    description:
      "We offer a wide range of home repair, assembly, and maintenance services in Galanta and surrounding areas.",
    features: [
      {
        image: "/icons/furniture_icon.svg",
        title: "Furniture Assembly",
        description:
          "Expert assembly of all types of furniture, shelving systems, kitchen units, and home equipment in Galanta. We work with IKEA, JYSK, Asko, and other brands.",
      ...
      },
      {
        ...
        description:
          "Professional installation of curtains, blinds, light fixtures, mirrors, TV brackets, and other home accessories in Galanta.",
      ...
      },
      {
        ...
        title: "Plumbing Work",
        description:
          "Minor plumbing repairs and replacements - dripping faucets, tap replacement, drain cleaning, sink replacement, and more in Galanta.",
        link: "/en/handyman-services",
      },
      {
        ...
        description:
          "Basic electrical work in Galanta - switch and outlet replacement, light fixture installation, appliance checks.",
        link: "/en/handyman-services",
      },
      {
        ...
        description:
          "Minor painting work, crack repair, filling, wallpapering, floor covering replacement, and other maintenance tasks in Galanta.",
        link: "/en/handyman-services",
      },
      {
        ...
        description:
          "Basic garden maintenance, outdoor furniture assembly, irrigation system installation, fence repairs in Galanta and nearby areas.",
        link: "/en/handyman-services",
      },
    ],
  };
  ...
  return (
    <main className="bg-white">
      ...
      <div>
        <LocationMap
          title="Handyman Services Throughout Galanta"
      ...
      <div className="pt-10 md:pt-[100px]">
        <FAQ
          title="Frequently Asked Questions About Handyman Services in Galanta"
          items={[
            {
              question: "What services does your handyman provide in Galanta?",
              answer:
            ...
            {
              question: "How much does a handyman cost in Galanta?",
              answer:
            ...
            {
              question: "How quickly can you come for an inspection in Galanta?",
              answer:
      ...
      <div className="pt-10 md:pt-[100px]">
        <CTA
          title="Need a handyman in Galanta?"
          description="Save your time and energy. Let our professionals handle your home repairs, assembly, and maintenance in Galanta. One call and your problem will be solved quickly and affordably."
