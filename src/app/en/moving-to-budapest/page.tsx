  ...
  return (
    <main className="bg-white">
      <Hero
        ...
        benefits={["Fast 1-day delivery", "Door-to-door service", "Fully insured"]}
      ...
      <RelatedServices
        ...
        services={[
          { title: "Moving Bratislava to Budapest", description: "Dedicated Bratislava–Budapest route page.", href: "/en/moving-bratislava-budapest", icon: "/icons/truck_icon.svg" },
