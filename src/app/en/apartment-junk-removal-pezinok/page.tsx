...
export const metadata = {
  title: "Apartment & House Junk Removal Pezinok | Sofoservis",
  description:
    "Professional apartment and house junk removal services in Pezinok ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment junk removal pezinok, house junk removal pezinok, home junk removal pezinok, property junk removal pezinok",
  alternates: {
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Junk Removal in Pezinok"
          description="Professional apartment and house junk removal services in Pezinok. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Junk Removal in Pezinok and Surroundings"
          description="We provide professional junk removal services in Pezinok and nearby areas"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Junk Removal in Pezinok"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment junk removal in Pezinok?"
