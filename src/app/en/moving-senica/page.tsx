...
export const metadata = {
  title: "Moving Services Senica - Apartments, Houses & Offices | Sofoservis",
  description:
...
export default function MovingSenicaPage() {
  const heroData = {
    title: "Moving Services in Senica",
    description:
      "Complete moving services in Senica and surrounding areas. Professional team, competitive prices, satisfaction guaranteed. We move apartments, houses, offices, and businesses throughout Senica.",
    formTitle: "Hassle-free moving in Senica with a free quote",
    formSubtitle: "Fill out the form below for a quick fixed price",
    backgroundImage: "/images/stahovanie_gauc.jpg",
  };

  const featuresData = {
    title: "Professional Moving Services in Senica",
    description:
      "Complete moving solutions for homes and businesses in Senica and surrounding areas.",
    features: [
      {
        image: "/icons/house_icon.svg",
        title: "Apartment & House Moving in Senica",
        description:
          "Complete apartment and house moving services in Senica. We safely transport your furniture and personal belongings to your new home.",
      ...
      },
      {
        ...
        description:
          "Professional office and business relocation in Senica. We minimize downtime by moving during weekends and holidays.",
      ...
      },
      {
        ...
        description:
          "Expert assembly and disassembly of any furniture during your move in Senica. We save your time and energy.",
      ...
      },
      {
        ...
        description:
          "We specialize in moving heavy items such as pianos, safes, and large furniture pieces in Senica.",
        link: "/en/moving-heavy-loads",
      },
      {
        image: "/icons/globe_icon.svg",
        title: "International Moving from Senica",
        description:
          "Moving from Senica abroad or vice versa. Complete solution for international relocation with minimum hassle.",
      ...
      },
      {
        ...
        description:
          "Complete property clearance services in Senica. Ideal for property sales, renovations, or estate settlements.",
  ...
  const mapData = {
    title: "We Move Throughout Senica",
    description:
      "Our services are available throughout Senica and surrounding areas for complete home and business relocations.",
    locations: [
          "Senica center",
          "Sobotište",
          "Kunov",
    ...
    additionalText: "Skalica, Holíč, Myjava, and other surrounding towns.",
  };

  const faqData = {
    title: "Frequently Asked Questions About Moving in Senica",
    items: [
      {
        question: "Which areas of Senica do you cover?",
        answer:
          "We provide our services throughout Senica and all surrounding towns and villages. Contact us for details about service in your specific location.",
      },
      {
        question: "What is the cost of moving in Senica?",
        answer:
      ...
      {
        question: "How far in advance should I book a move in Senica?",
        answer:
      ...
      {
        question: "Do you provide furniture assembly and disassembly in Senica?",
        answer:
      ...
      {
        question: "Can you move heavy items like pianos or safes in Senica?",
        answer:
    ...
    <main className="bg-white">
      ...
      <div>
        <CTA
          ...
          description="Let us handle your move in Senica with professional care. Contact us today for a free quote."
