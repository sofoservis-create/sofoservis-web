    ...
    features: [
      {
        ...
        description:
          "Expert assembly of furniture from IKEA, JYSK, Asko, and other brands. We assemble any type of furniture according to instructions quickly and precisely with our own tools.",
