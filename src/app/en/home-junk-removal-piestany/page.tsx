...
export const metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: "https://www.sofoservis.sk/en/home-junk-removal-piestany",
      "x-default": "https://www.sofoservis.sk/vypratavanie-piestany",
    },
  },
};

export default function HomeJunkRemovalPiestanyPage() {
  const faqItems = [
    { question: "How does the junk removal process work in Piešťany?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home junk removal in Piešťany?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
  ...
  const cityIntro =
    "Piešťany is a renowned spa town with a mix of hotel and apartment properties, guesthouses, and older family homes on both banks of the Váh river. Junk Removal in Piešťany often involves spa-related properties, old town-centre flats, and riverside cottages being prepared for sale or redevelopment.";
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Junk Removal Services in Piešťany"
          description="Professional and fast home junk removal services in Piešťany and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Junk Removal in Piešťany and Surroundings"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Junk Removal in Piešťany"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home junk removal in Piešťany?"
