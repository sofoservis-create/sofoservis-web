...
export const metadata = {
  title: "Home Junk Removal Levice | Sofoservis",
  description:
    "Professional home junk removal services in Levice ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home junk removal levice, house junk removal levice, property junk removal levice, estate junk removal levice",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-junk-removal-levice",
    languages: {
      sk: "https://www.sofoservis.sk/vypratavanie-levice",
      en: "https://www.sofoservis.sk/en/home-junk-removal-levice",
      "x-default": "https://www.sofoservis.sk/vypratavanie-levice",
    },
  },
};

export default function HomeJunkRemovalLevicePage() {
  const faqItems = [
    { question: "How does the junk removal process work in Levice?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home junk removal in Levice?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange junk removal in Levice?", answer: "We can typically arrange junk removal in Levice within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  const nearbyTowns = ["Šurany", "Zlaté Moravce", "Nitra", "Tlmače", "Želiezovce"];

  const cityIntro =
    "Levice is the regional capital of Nitra County with large housing estates built during the 1970s and 80s alongside older family homes. Junk Removal in Levice most often involves flats on upper floors without lifts, as well as older family homes with extensive garden outbuildings in the surrounding villages.";
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Junk Removal Services in Levice"
          description="Professional and fast home junk removal services in Levice and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
          formTitle="Get a free price quote"
          formSubtitle="Fill out the form for a no-obligation estimate in Levice"
      ...
      <div>
        <LocationMap
          title="Home Junk Removal in Levice and Surroundings"
          description="We provide professional services in Levice and nearby locations"
          locations={nearbyTowns}
          additionalText="We serve the entire Levice district and surrounding areas in the Nitra region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Junk Removal in Levice"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home junk removal in Levice?"
          description="Let our experienced team handle everything - from sorting items to final space cleaning. We operate in all parts of Levice."
