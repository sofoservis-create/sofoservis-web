...
export const metadata = {
  ...
  description:
    "Transparent prices for our services. Moving from €25/hr, clearance from €25/hr, furniture assembly from €20. Free inspection! Contact us for a no-obligation quote.",
  alternates: {
