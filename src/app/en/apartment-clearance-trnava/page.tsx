...
export const metadata = {
  title: "Apartment & House Clearance Trnava | Sofoservis",
  description:
    "Professional apartment and house clearance services in Trnava ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance trnava, house clearance trnava, home clearance trnava, property clearance trnava",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-trnava",
    languages: {
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Clearance in Trnava"
          description="Professional apartment and house clearance services in Trnava. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Trnava and Surroundings"
          description="We provide professional clearance services in Trnava and nearby areas"
          locations={["Trnava","Hlohovec","Piešťany","Galanta","Sereď","Zavar","Modra","Smolenice"]}
          additionalText="We also serve surrounding towns in the Trnava region."
        />
      </div>
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Trnava"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Trnava?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Trnava and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-trnava", icon: "/icons/truck_icon.svg" },
        ]}
      />
