...
export const metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      en: "https://www.sofoservis.sk/en/home-junk-removal-karlova-ves",
      "x-default": "https://www.sofoservis.sk/vypratavanie-karlova-ves",
    },
  },
};

export default function HomeJunkRemovalKarlovaVesPage() {
  const faqItems = [
    { question: "How does the junk removal process work in Karlova Ves?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home junk removal in Karlova Ves?", answer: "The cost depends on space size, amount of items, accessibility (floor number, elevator), waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. We provide a free on-site quote." },
    { question: "How quickly can you arrange junk removal in Karlova Ves?", answer: "Being based in Bratislava, we can often arrange junk removal in Karlova Ves within 24-48 hours. Contact us for the earliest available term." },
    { question: "Do you handle junk removal in villas and apartment blocks in Karlova Ves?", answer: "Yes, we provide junk removal for all types of properties in Karlova Ves, including apartment blocks in Dlhé diely and villas in the older parts of the district." },
  ];
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Junk Removal Services in Karlova Ves"
          description="Professional and fast home junk removal services in Karlova Ves district of Bratislava. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Junk Removal in Karlova Ves District"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Junk Removal in Karlova Ves"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home junk removal in Karlova Ves?"
