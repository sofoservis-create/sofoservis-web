...
export default function ConstructionWasteRemovalGalantaPage() {
  ...
  const heroData = {
    ...
    description:
      "Professional and fast construction waste removal and ecological disposal services in Galanta and surrounding areas. We handle waste from renovations, demolitions, or construction at competitive prices with complete disposal documentation.",
