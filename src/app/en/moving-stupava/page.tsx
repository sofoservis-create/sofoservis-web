...
export const metadata = {
  title: "Moving Services Stupava - Apartments, Houses & Offices | Sofoservis",
  description:
...
export default function MovingStupavaPage() {
  const heroData = {
    title: "Moving Services in Stupava",
    description:
      "Complete moving services in Stupava and surrounding areas. Professional team, competitive prices, satisfaction guaranteed. We move apartments, houses, offices, and businesses throughout Stupava.",
    formTitle: "Hassle-free moving in Stupava with a free quote",
    formSubtitle: "Fill out the form below for a quick fixed price",
    backgroundImage: "/images/stahovanie_gauc.jpg",
  };

  const featuresData = {
    title: "Professional Moving Services in Stupava",
    description:
      "Complete moving solutions for homes and businesses in Stupava and surrounding areas.",
    features: [
      {
        image: "/icons/house_icon.svg",
        title: "Apartment & House Moving in Stupava",
        description:
          "Complete apartment and house moving services in Stupava. We safely transport your furniture and personal belongings to your new home.",
      ...
      },
      {
        ...
        description:
          "Professional office and business relocation in Stupava. We minimize downtime by moving during weekends and holidays.",
      ...
      },
      {
        ...
        description:
          "Expert assembly and disassembly of any furniture during your move in Stupava. We save your time and energy.",
      ...
      },
      {
        ...
        description:
          "We specialize in moving heavy items such as pianos, safes, and large furniture pieces in Stupava.",
        link: "/en/moving-heavy-loads",
      },
      {
        image: "/icons/globe_icon.svg",
        title: "International Moving from Stupava",
        description:
          "Moving from Stupava abroad or vice versa. Complete solution for international relocation with minimum hassle.",
      ...
      },
      {
        ...
        description:
          "Complete property clearance services in Stupava. Ideal for property sales, renovations, or estate settlements.",
  ...
  const mapData = {
    title: "We Move Throughout Stupava",
    description:
      "Our services are available throughout Stupava and surrounding areas for complete home and business relocations.",
    locations: [
          "Stupava center",
          "Borinka",
          "Lozorno",
    ...
    additionalText: "Bratislava, Malacky, Pezinok, and other surrounding towns.",
  };

  const faqData = {
    title: "Frequently Asked Questions About Moving in Stupava",
    items: [
      {
        question: "Which areas of Stupava do you cover?",
        answer:
          "We provide our services throughout Stupava and all surrounding towns and villages. Contact us for details about service in your specific location.",
      },
      {
        question: "What is the cost of moving in Stupava?",
        answer:
      ...
      {
        question: "How far in advance should I book a move in Stupava?",
        answer:
      ...
      {
        question: "Do you provide furniture assembly and disassembly in Stupava?",
        answer:
      ...
      {
        question: "Can you move heavy items like pianos or safes in Stupava?",
        answer:
    ...
    <main className="bg-white">
      ...
      <div>
        <CTA
          ...
          description="Let us handle your move in Stupava with professional care. Contact us today for a free quote."
