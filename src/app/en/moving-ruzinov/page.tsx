...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Our rates start from €35/hour per worker. Moving within Ružinov or to other parts of Bratislava starts from €60. For a standard 2-bedroom apartment move, 3 workers are usually the most efficient choice.",
  },
  {
    ...
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Home Clearance", description: "Property clearance in Ružinov from €35/hour.", href: "/en/home-junk-removal-ruzinov", icon: "/icons/vypratavanie_icon.svg" },
