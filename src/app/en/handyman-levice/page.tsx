...
export default function HandymanLevicePage() {
  ...
  const heroData = {
    ...
    description:
      "Professional handyman services in Levice and surrounding areas for quick and reliable repairs, assembly, and home maintenance. We cover all of Levice and nearby towns.",
