...
export const metadata = {
  title: "Home Clearance Karlova Ves Bratislava | Sofoservis",
  description:
    "Professional home clearance services in Karlova Ves, Bratislava ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance karlova ves, house clearance karlova ves, property clearance karlova ves, estate clearance karlova ves",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-karlova-ves",
    languages: {
...
export default function HomeClearanceKarlovaVesPage() {
  const faqItems = [
    { question: "How does the clearance process work in Karlova Ves?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Karlova Ves?", answer: "The cost depends on space size, amount of items, accessibility (floor number, elevator), waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Karlova Ves?", answer: "Being based in Bratislava, we can often arrange clearance in Karlova Ves within 24-48 hours. Contact us for the earliest available term." },
    { question: "Do you handle clearance in villas and apartment blocks in Karlova Ves?", answer: "Yes, we provide clearance for all types of properties in Karlova Ves, including apartment blocks in Dlhé diely and villas in the older parts of the district." },
  ];

  return (
    <main className="bg-white">
      <Hero
        title="Home Clearance Services in Karlova Ves"
        description="Professional and fast home clearance services in Karlova Ves district of Bratislava. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
        formTitle="Get a free price quote"
        formSubtitle="Fill out the form for a no-obligation estimate in Karlova Ves"
      ...
      <div>
        <LocationMap
          title="Home Clearance in Karlova Ves District"
          description="We provide professional services in Karlova Ves and surrounding Bratislava districts"
          locations={["Karlova Ves", "Dlhé diely", "Dúbravka", "Staré Mesto", "Petržalka", "Devín", "Lamač"]}
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Karlova Ves"
          items={faqItems}
        />
      </div>
