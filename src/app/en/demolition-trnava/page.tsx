...
export default function DemolitionTrnavaPage() {
  ...
  const heroData = {
    ...
    description:
      "Professional demolition services in Trnava and surrounding areas. We ensure safe demolition of houses, buildings, barns, and other structures with minimal impact on the surroundings. Our expert team handles the entire process from preparation to waste removal and ecological disposal.",
