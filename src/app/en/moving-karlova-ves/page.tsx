...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Moving in Karlova Ves starts from €35/hour per worker. A standard move with 3 workers costs €90/hour. Moving within Bratislava starts from €60. Contact us for a free fixed price quote.",
  },
  {
    ...
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Home Clearance", description: "Property clearance in Karlova Ves from €35/hour.", href: "/en/home-junk-removal-karlova-ves", icon: "/icons/vypratavanie_icon.svg" },
