...
const faqItems = [
  {
    question: "What do you remove during cottage junk removal?",
    answer:
  ...
  {
    question: "What is the cost of cottage junk removal?",
    answer:
...
export default function CottageJunkRemovalPage() {
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Cottage & Rural Property Junk Removal"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Cottage Junk Removal"
          items={faqItems}
        />
      </div>
      <div>
        <CTA
          ...
          description="We provide complete junk removal — interior, garden, barn. Even in remote locations, even in your absence."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Property Land Junk Removal", description: "Cleaning of land and gardens.", href: "/en/property-land-junk-removal", icon: "/icons/landscape_icon.svg" },
          ...
          { title: "Estate Junk Removal", description: "Sensitive bereavement junk removal services.", href: "/en/estate-junk-removal-bereavement", icon: "/icons/house_icon.svg" },
        ]}
      />
