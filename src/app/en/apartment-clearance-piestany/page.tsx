...
export const metadata = {
  title: "Apartment & House Clearance Piešťany | Sofoservis",
  description:
    "Professional apartment and house clearance services in Piešťany ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance piešťany, house clearance piešťany, home clearance piešťany, property clearance piešťany",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-piestany",
    languages: {
...
export default function ApartmentClearancePiestanyPage() {
  const faqItems = [
    { question: "How does the apartment clearance process work in Piešťany?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment clearance cost in Piešťany?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange clearance in Piešťany?", answer: "We can usually arrange clearance in Piešťany within 2-4 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Piešťany and Surroundings"
          description="We provide professional clearance services in Piešťany and nearby areas"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Piešťany"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Piešťany?"
