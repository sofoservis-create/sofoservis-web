...
export const metadata = {
  title: "Apartment & House Clearance Galanta | Sofoservis",
  description:
    "Professional apartment and house clearance services in Galanta ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "apartment clearance galanta, house clearance galanta, home clearance galanta, property clearance galanta",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/apartment-clearance-galanta",
    languages: {
...
export default function ApartmentClearanceGalantaPage() {
  const faqItems = [
    { question: "How does the apartment clearance process work in Galanta?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all equipment needed. We sort items per your instructions, remove all unwanted materials, and leave the space clean." },
    { question: "How much does apartment clearance cost in Galanta?", answer: "Cost depends on the size of the apartment or house, the amount of items, accessibility (floor, lift), waste type, and any additional services. For a standard 2-bedroom apartment, prices typically range from €350 to €700. We provide a free, no-obligation quote after a site inspection." },
    { question: "How quickly can you arrange clearance in Galanta?", answer: "We can usually arrange clearance in Galanta within 2-4 working days." },
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Apartment & House Clearance in Galanta"
          description="Professional apartment and house clearance services in Galanta. Our team handles sorting, removal, and ecological disposal of all items — at fair prices with a free site inspection."
      ...
      <div>
        <LocationMap
          title="Apartment Clearance in Galanta and Surroundings"
          description="We provide professional clearance services in Galanta and nearby areas"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions — Apartment Clearance in Galanta"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need apartment clearance in Galanta?"
          description="Our experienced team handles everything — from sorting items to final space cleaning in Galanta and surroundings."
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Apartment Moving", description: "Professional apartment and home relocation.", href: "/en/moving-galanta", icon: "/icons/truck_icon.svg" },
        ]}
      />
