...
export const metadata = {
  title: "Home Clearance Levice | Sofoservis",
  description:
    "Professional home clearance services in Levice ✅ Affordable prices ✅ Free site inspection ✅ Contact us today!",
  keywords:
    "home clearance levice, house clearance levice, property clearance levice, estate clearance levice",
  alternates: {
    canonical: "https://www.sofoservis.sk/en/home-clearance-levice",
    languages: {
...
export default function HomeClearanceLevicePage() {
  const faqItems = [
    { question: "How does the clearance process work in Levice?", answer: "The process starts with a free site inspection where we estimate the scope of work and prepare a quote. On the agreed day, our team arrives with all necessary equipment. We sort items per your instructions, pack and remove all unwanted materials, and clean the space." },
    { question: "What is the cost of home clearance in Levice?", answer: "The cost depends on space size, amount of items, accessibility, waste type, and additional services. For a standard 2-bedroom apartment, prices range from €350 to €700. For a family house, from €600 to €1,500. We provide a free on-site quote." },
    { question: "How quickly can you arrange clearance in Levice?", answer: "We can typically arrange clearance in Levice within 2-5 working days. In urgent cases, we try to accommodate your schedule sooner. Contact us to discuss your specific needs." },
  ...
  const cityIntro =
    "Levice is the regional capital of Nitra County with large housing estates built during the 1970s and 80s alongside older family homes. Clearance in Levice most often involves flats on upper floors without lifts, as well as older family homes with extensive garden outbuildings in the surrounding villages.";
  ...
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Home Clearance Services in Levice"
          description="Professional and fast home clearance services in Levice and surrounding areas. Our team handles everything from sorting items, packing and removal, to ecological waste disposal - all at fair prices."
      ...
      <div>
        <LocationMap
          title="Home Clearance in Levice and Surroundings"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Home Clearance in Levice"
          items={faqItems}
        />
      </div>
      ...
      <div>
        <CTA
          title="Need professional home clearance in Levice?"
