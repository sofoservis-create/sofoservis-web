...
const faqItems = [
  {
    question: "What does post-renovation junk removal include?",
    answer:
...
export default function PostRenovationJunkRemovalPage() {
  return (
    <main className="bg-white">
      ...
      <div className="hidden lg:block">
        <LabHero
          narrowForm
          title="Post-Renovation Junk Removal Services"
      ...
      <div>
        <FAQ
          title="Frequently Asked Questions About Renovation Junk Removal"
          items={faqItems}
        />
      </div>
      <div>
      ...
      />
      <ServicePricing filter={["junk removal", "demolition"]} lang="en" />
      <TrustBadges lang="en" />
