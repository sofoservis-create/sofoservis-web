...
export default function VypratavanieKarlovaVesPage() {
  const heroData = {
    ...
    description:
      "Vypratávame byty, pivnice a rodinné domy v celej Karlovej Vsi od 25€/hod. Dlhé diely, Líščie údolie, Nad lúčkami — pokrývame celú mestskú časť. Odvoz odpadu zabezpečíme. Obhliadka zadarmo.",
  ...
  return (
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[{"title":"Vypratávanie Bratislava","description":"Vypratávanie bytov a priestorov v Bratislave od 25€/hod.","href":"/vypratavanie-bratislava","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie bytov a domov","description":"Kompletné vypratanie bytu alebo domu.","href":"/vypratavanie-bytov-domov","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie pivníc a garáží","description":"Rýchle vypratanie pivníc, kobiek a garáží.","href":"/vypratavanie-pivnic-garazi-nebytovych-priestorov","icon":"/icons/house_icon.svg"},{"title":"Sťahovanie Karlova Ves","description":"Sťahovanie v Karlovej Vsi od 25€/hod.","href":"/stahovanie-karlova-ves","icon":"/icons/truck_icon.svg"}]}
      />
