...
export const metadata = {
  title: "Vypratávanie pivníc a nebytových priestorov Bratislava | Sofoservis",
  description:
...
export default function VypratavaniePivnicGaraziBratislavaPage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne a rýchle vypratávanie pivníc, garáží, skladov, povál a ďalších nebytových priestorov v Bratislave a okolí. Zabezpečíme kompletné vyčistenie a vypratanie akéhokoľvek priestoru bez ohľadu na stupeň znečistenia či množstvo nahromadeného materiálu.",
  ...
  return (
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[{"title":"Vypratávanie Bratislava","description":"Vypratávanie bytov a priestorov v Bratislave od 25€/hod.","href":"/vypratavanie-bratislava","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie bytov a domov","description":"Kompletné vypratanie bytu alebo domu.","href":"/vypratavanie-bytov-domov","icon":"/icons/broom_icon.svg"},{"title":"Odvoz stavebného odpadu","description":"Rýchly odvoz suťa, podláh a stavebného odpadu.","href":"/odvoz-likvidacia-stavebneho-odpadu","icon":"/icons/recycle_icon.svg"},{"title":"Sťahovanie Bratislava","description":"Profesionálne sťahovanie v celej Bratislave.","href":"/stahovanie-bratislava","icon":"/icons/truck_icon.svg"}]}
      />
