...
export const metadata = {
  ...
  description:
    "Profesionálne vypratávanie bytov, pivníc a garáží v Bratislave od 25€/hod. Jednoizbový byt od 200€. Pokrývame všetky mestské časti — Petržalka, Ružinov, Staré Mesto a ďalšie.",
  alternates: {
...
export default function VypratavanieBratislavaPage() {
  const heroData = {
    ...
    description:
      "Vypratávame byty, pivnice, kobky a garáže v celej Bratislave od 25€/hod. Pokrývame Petržalku, Ružinov, Staré Mesto, Nové Mesto, Karlovú Ves, Dúbravku a ďalšie časti. Odvoz a likvidácia odpadu v cene. Obhliadka zadarmo.",
    ...
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[
          ...
          { title: "Vypratávanie bytov a domov", description: "Kompletné vypratávanie domácností.", href: "/vypratavanie-bytov-domov", icon: "/icons/broom_icon.svg" },
