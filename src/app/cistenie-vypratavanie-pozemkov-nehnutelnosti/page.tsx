...
export default function CisteniePozemkovPage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne čistenie a vypratávanie pozemkov od 25€/hod. Odstraňujeme náletové dreviny, odpad a nežiaducu vegetáciu. Pripravíme váš pozemok na výstavbu, predaj alebo rekultiváciu rýchlo a za prijateľné ceny.",
  ...
  const featuresData = {
    ...
    features: [
      ...
      {
        image: "/icons/broom_icon.svg", // For basement/garage cleaning
  ...
  return (
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[{"title":"Vypratávanie bytov a domov","description":"Kompletné vypratanie bytu alebo domu.","href":"/vypratavanie-bytov-domov","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie pivníc a garáží","description":"Rýchle vypratanie pivníc, kobiek a garáží.","href":"/vypratavanie-pivnic-garazi-nebytovych-priestorov","icon":"/icons/house_icon.svg"},{"title":"Odvoz stavebného odpadu","description":"Rýchly odvoz suťa, podláh a stavebného odpadu.","href":"/odvoz-likvidacia-stavebneho-odpadu","icon":"/icons/recycle_icon.svg"},{"title":"Búranie a demolácia","description":"Profesionálne búranie stien, predelov a objektov.","href":"/buranie-demolacia-domov-bytov","icon":"/icons/crane_icon.svg"}]}
      />
    </main>
  );
}
