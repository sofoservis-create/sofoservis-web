...
export default function CisteniePozemkovPage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne čistenie a kompletné vypratávanie pozemkov od náletových drevín, odpadu a nežiaducej vegetácie. Pripravíme váš pozemok na výstavbu, predaj alebo rekultiváciu rýchlo a za prijateľné ceny.",
