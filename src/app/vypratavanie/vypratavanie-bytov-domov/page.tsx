...
export default function VypratavanieBytovDomovPage() {
  ...
  return (
    <main className="bg-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
            {[
              ...
              <span
                key={city}
                className="block px-4 py-3 bg-white rounded-lg border border-gray-200 text-center text-sm font-medium text-primary-900"
              >
                Vypratávanie {city}
              </span>
            ))}
      ...
      <ServicePriceTable variant="vypratavanie" title="Cenník vypratávania bytov a domov" />
