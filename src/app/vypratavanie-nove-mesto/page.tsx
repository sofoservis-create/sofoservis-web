...
export default function VypratavanieNoveMestoPage() {
  const heroData = {
    ...
    description:
      "Vypratávame byty, pivnice a garáže po celom Novom Meste v Bratislave od 25€/hod. Vinohrady, Kramáre, Koliba — pokrývame celú mestskú časť. Odvoz odpadu zabezpečíme. Obhliadka zadarmo.",
  ...
  return (
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[{"title":"Vypratávanie Bratislava","description":"Vypratávanie bytov a priestorov v Bratislave od 25€/hod.","href":"/vypratavanie-bratislava","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie bytov a domov","description":"Kompletné vypratanie bytu alebo domu.","href":"/vypratavanie-bytov-domov","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie pivníc a garáží","description":"Rýchle vypratanie pivníc, kobiek a garáží.","href":"/vypratavanie-pivnic-garazi-nebytovych-priestorov","icon":"/icons/house_icon.svg"},{"title":"Sťahovanie Nové Mesto","description":"Sťahovanie v Novom Meste od 25€/hod.","href":"/stahovanie-nove-mesto","icon":"/icons/truck_icon.svg"}]}
      />
