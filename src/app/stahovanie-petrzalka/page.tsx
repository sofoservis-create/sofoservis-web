...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovanie v Petržalke. Skúsenosti so sťahovaním z panelových domov, vynáškou bez výťahu a dopravou po celej Bratislave. Cenová ponuka zadarmo.",
  alternates: {
