...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovanie v Karlovej Vsi. Sťahujeme byty, domy a kancelárie v celej Karlovej Vsi a okolí. Rýchlo, spoľahlivo, za výhodné ceny.",
  alternates: {
  ...
  openGraph: {
    title: "Sťahovanie Karlova Ves Bratislava - byty, domy | Sofoservis",
    description:
      "Profesionálne sťahovanie v Karlovej Vsi od 30€/hod. Byty, domy, paneláky. Skúsený tím, férové ceny.",
...
export default function StahovanieKarlovaVesPage() {
  const heroData = {
    ...
    description:
      "Sťahujeme byty, domy a kancelárie v celej Karlovej Vsi Bratislavy. Skúsený tím, výhodné ceny, spokojnosť garantovaná. Pokrývame Patrónku a Líščie údolie.",
  ...
  const faqData = {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Sťahovanie v Karlovej Vsi účtujeme od 30€/hod na pracovníka. Najobľúbenejšia možnosť sú 3 pracovníci za 80€/hod. Sťahovanie v rámci mesta od 55€. Pre presný odhad vyplňte formulár — ponuka je zadarmo.",
      },
      {
