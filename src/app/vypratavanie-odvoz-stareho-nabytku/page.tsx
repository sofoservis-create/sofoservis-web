...
export const metadata = {
  title: "Odvoz, vypratávanie a likvidácia starého nábytku | Sofoservis",
  description:
...
export default function VypratavaniaOdvozStarehoNabytkuPage() {
  ...
  const heroData = {
    ...
    description:
      "Komplexné služby pre odvoz a ekologickú likvidáciu starého nábytku. Náš profesionálny tím zabezpečí kompletné vypratanie vašich priestorov a environmentálne zodpovedné zneškodnenie všetkého nepotrebného nábytku a zariadenia.",
  ...
  return (
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[{"title":"Vypratávanie bytov a domov","description":"Kompletné vypratanie bytu alebo domu.","href":"/vypratavanie-bytov-domov","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie pivníc a garáží","description":"Rýchle vypratanie pivníc, kobiek a garáží.","href":"/vypratavanie-pivnic-garazi-nebytovych-priestorov","icon":"/icons/house_icon.svg"},{"title":"Odvoz stavebného odpadu","description":"Rýchly odvoz suťa, podláh a stavebného odpadu.","href":"/odvoz-likvidacia-stavebneho-odpadu","icon":"/icons/recycle_icon.svg"},{"title":"Čistenie a vypratávanie pozemkov","description":"Kompletné čistenie a vypratávanie pozemkov.","href":"/cistenie-vypratavanie-pozemkov-nehnutelnosti","icon":"/icons/landscape_icon.svg"}]}
      />
