...
import ContactFormSection from "@/components/sections/ContactFormSection";
  ...
  export default function VypratavanieNitraPage() {
    const heroData = {
      ...
      description:
        "Vypratávame byty, pivnice, kobky a garáže v celej Nitre od 25€/hod. Odvoz a likvidácia starého nábytku, spotrebičov aj odpadu — všetko v jednej službe.",
  ...
  const cityIntro =
    "Nitra je krajské mesto Nitrianskeho kraja s rozsiahlymi sídliskami zo 70. a 80. rokov. Starší bytový fond panelových domov v Nitre pravidelne prechádza rekonštrukciami a predajom, pri ktorých je profesionálne vypratanie nevyhnutnosťou. Pokrývame celú Nitru vrátane Čermáňa, Klokočiny, Chrenovej, Dielov aj okolitých prímestských obcí.";
