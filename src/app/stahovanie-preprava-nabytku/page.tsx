...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovanie a preprava nábytku. Lacné a férové ceny. Bezpečná manipulácia. Obhliadka priestoru zadarmo.",
  keywords:
...
export default function StahovaniePrepravaNabytkuPage() {
  const faqItems = [
    { question: "Potrebuje sa nábytok pred sťahovaním rozobrať?", answer: "Závisí to od typu nábytku a prístupových podmienok. Niektoré kusy, ako sedačky a postele, sa často nepotrebujú rozoberať. Naopak, skrine a väčšie kusy nábytku je vhodné rozobrať, najmä ak sú úzke dvere alebo schodisko. Náš tím pri obhliadke posúdi, ktoré kusy je potrebné demontovať pre bezpečnú prepravu." },
    { question: "Ako ochránite môj nábytok počas prepravy pred poškodením?", answer: "Každý kus nábytku je individuálne zabalený podľa jeho typu a potrieb. Používame štrečové fólie, bublinové fólie, kartónové obaly, ochranné deky a rohové chrániče. Čalúnený nábytok balíme do špeciálnych obalov, drevený nábytok chránime pred poškriabaním." },
    { question: "Je možné prepraviť aj veľmi veľké kusy nábytku, ako je klavír alebo vitríny?", answer: "Áno, špecializujeme sa aj na prepravu nadrozmerných a ťažkých kusov nábytku. Pre klavíry, vitríny, trezory a podobné predmety máme špeciálne vybavenie ako sťahovacie popruhy, plošiny a vozíky." },
    { question: "Ako dlho dopredu treba objednať prepravu nábytku?", answer: "Pre štandardnú prepravu nábytku odporúčame objednať službu aspoň 3-7 dní vopred. Pri väčšom množstve alebo špecifických kusoch je lepšie termín dohodnúť 1-2 týždne dopredu. V prípade urgentnej potreby však často dokážeme zabezpečiť službu aj do 24-48 hodín." },
    { question: "Ponúkate aj samostatnú službu montáže nábytku?", answer: "Áno, okrem kompletného sťahovania ponúkame aj samostatnú službu montáže a demontáže nábytku. Či už potrebujete poskladať nový nábytok z obchodu, rozobrať starý pred rekonštrukciou, alebo znova zložiť nábytok po presťahovaní, náš tím vám s tým ochotne pomôže." },
  ];
  ...
  const featuresData = {
    ...
    features: [
      ...
      {
        image: "/icons/vypratavanie_icon.svg", // Was: /images/icon6.webp
