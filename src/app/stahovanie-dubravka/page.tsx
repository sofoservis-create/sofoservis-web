...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovanie v Dúbravke. Sťahujeme byty z panelových domov aj rodinné domy. Skúsenosti s vynáškou bez výťahu. Rýchlo a za výhodné ceny. Ponuka zadarmo.",
  alternates: {
