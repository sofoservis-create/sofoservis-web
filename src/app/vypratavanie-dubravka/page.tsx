...
export default function VypratavanieDubravkaPage() {
  const heroData = {
    ...
    description:
      "Vypratávame byty, pivnice a rodinné domy v celej Dúbravke od 25€/hod. Odvoz a likvidácia starého nábytku, spotrebičov aj stavebného odpadu — všetko v jednej službe. Obhliadka zadarmo.",
  ...
  return (
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[{"title":"Vypratávanie Bratislava","description":"Vypratávanie bytov a priestorov v Bratislave od 25€/hod.","href":"/vypratavanie-bratislava","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie bytov a domov","description":"Kompletné vypratanie bytu alebo domu.","href":"/vypratavanie-bytov-domov","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie pivníc a garáží","description":"Rýchle vypratanie pivníc, kobiek a garáží.","href":"/vypratavanie-pivnic-garazi-nebytovych-priestorov","icon":"/icons/house_icon.svg"},{"title":"Sťahovanie Dúbravka","description":"Sťahovanie v Dúbravke od 25€/hod.","href":"/stahovanie-dubravka","icon":"/icons/truck_icon.svg"}]}
      />
