...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovacie služby v Leviciach a okolí. Rýchlo, spoľahlivo a za výhodné ceny. Sťahujeme byty, domy, kancelárie a firmy v celom meste a širšom okolí.",
  alternates: {
