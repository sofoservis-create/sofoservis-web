...
import ContactFormSection from "@/components/sections/ContactFormSection";
  ...
  export default function VypratavanieLevicePage() {
    const heroData = {
      ...
      description:
        "Vypratávame byty, pivnice, kobky a garáže v celých Leviciach od 25€/hod. Odvoz a likvidácia starého nábytku, spotrebičov aj odpadu — všetko v jednej službe. Obhliadka zadarmo.",
