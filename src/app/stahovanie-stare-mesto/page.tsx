...
export const metadata = {
  ...
  description:
    "Sťahovanie v Starom Meste Bratislava. Skúsenosti so sťahovaním v centre mesta, historických budovách a bez parkovania. Vybavíme parkovacie povolenie. Cenová ponuka zadarmo.",
  alternates: {
...
export default function StahovanieStareMestoPage() {
  const heroData = {
    ...
    description:
      "Sťahujeme v Starom Meste Bratislavy vrátane historických budov, bytov bez výťahu a lokalít s obmedzeným parkovaním. Vybavíme parkovacie povolenie a postaráme sa o každý detail.",
