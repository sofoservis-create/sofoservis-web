...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovacie služby v Senci a okolí. Rýchlo, spoľahlivo a za výhodné ceny. Sťahujeme byty, domy, kancelárie a firmy v meste Senec a v okolitých obciach.",
  keywords:
...
export default function StahovanieSenecPage() {
  ...
  const heroData = {
    ...
    description:
      "Kompletné sťahovacie služby v Senci a okolí. Profesionálny tím, výhodné ceny, spokojnosť garantovaná. Presťahujeme vás v rámci Senca alebo kamkoľvek potrebujete.",
