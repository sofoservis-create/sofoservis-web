...
export default function StahovanieBytovDomovPage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne sťahovanie bytov a domov od 25€/hod. Šetríme váš čas, energiu a nervy vďaka skúsenému tímu, ktorý sa postará o všetko od balenia až po vybalenie na novom mieste.",
    ...
    <main className="bg-white">
      ...
      <ContactFormSection />
        ...
        services={[
          ...
          { title: "Vypratávanie bytov", description: "Kompletné vypratanie vrátane odvozu odpadu.", href: "/vypratavanie-bytov-domov", icon: "/icons/broom_icon.svg" },
