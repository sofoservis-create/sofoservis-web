...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovacie služby v Hlohovci a okolí. Rýchlo, spoľahlivo a za výhodné ceny. Sťahujeme byty, domy, kancelárie a firmy v celom meste.",
  alternates: {
  ...
  openGraph: {
      title: "Sťahovanie Hlohovec - byty, domy, nábytok a kancelárie | Sofoservis",
      description: "Profesionálne sťahovacie služby v Hlohovci a okolí od 25€/hod. Rýchlo, spoľahlivo a za výhodné ceny. Sťahujeme byty, domy a kancelárie.",
      url: "https://www.sofoservis.sk/stahovanie-hlohovec",
      siteName: "Sofoservis",
