...
export default function HodinovyManzelMajsterPage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne služby hodinového manžela od 20€/hod. Rýchle a spoľahlivé opravy, montáže a údržba vo vašej domácnosti. Pomôžeme vám s prácami, na ktoré nemáte čas, náradie alebo zručnosti.",
    ...
    <main className="bg-white">
      ...
      <ContactFormSection />
        ...
        services={[
          ...
          { title: "Vypratávanie bytov", description: "Kompletné vypratanie a odvoz nepotrebných vecí.", href: "/vypratavanie-bytov-domov", icon: "/icons/broom_icon.svg" },
        ]}
      />
