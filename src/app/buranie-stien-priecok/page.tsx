...
export default function BuranieStienPriecokPage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne služby v oblasti búrania a odstraňovania nosných stien, nenosných priečok a vytvárania otvorov v stenách. Zabezpečíme statický posudok, stavebné povolenie, bezpečné búranie a odvoz stavebného odpadu.",
