...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovanie v Novom Meste Bratislava. Sťahujeme byty, rodinné domy a kancelárie. Pokrývame Kramáre, Kolibu, Vinohrady aj celé Nové Mesto. Ponuka zadarmo.",
  alternates: {
