...
export default function VypratavanieBytovDomovBratislavaPage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne a rýchle vypratávanie bytov, domov a nehnuteľností v Bratislave a okolí. Náš tím sa postará o komplexné služby od triedenia vecí, cez balenie a odvoz, až po ekologickú likvidáciu odpadu - to všetko za férové ceny.",
  ...
  return (
    <main className="bg-white">
      ...
      <RelatedServices
        ...
        services={[{"title":"Vypratávanie Bratislava","description":"Vypratávanie bytov a priestorov v Bratislave od 25€/hod.","href":"/vypratavanie-bratislava","icon":"/icons/broom_icon.svg"},{"title":"Vypratávanie pivníc a garáží","description":"Rýchle vypratanie pivníc, kobiek a garáží.","href":"/vypratavanie-pivnic-garazi-nebytovych-priestorov","icon":"/icons/house_icon.svg"},{"title":"Sťahovanie Bratislava","description":"Profesionálne sťahovanie v celej Bratislave.","href":"/stahovanie-bratislava","icon":"/icons/truck_icon.svg"},{"title":"Odvoz stavebného odpadu","description":"Rýchly odvoz suťa, podláh a stavebného odpadu.","href":"/odvoz-likvidacia-stavebneho-odpadu","icon":"/icons/recycle_icon.svg"}]}
      />
