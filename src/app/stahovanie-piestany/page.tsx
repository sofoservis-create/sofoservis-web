...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovacie služby v Piešťanoch a okolí. Rýchlo, spoľahlivo a za výhodné ceny. Sťahujeme byty, domy, kancelárie a firmy v celom meste a širšom okolí.",
  alternates: {
...
export default function StahovaniePiestanyPage() {
  ...
  const heroData = {
    ...
    description:
      "Kompletné sťahovacie služby v Piešťanoch a okolí. Profesionálny tím, výhodné ceny, spokojnosť garantovaná. Sťahujeme byty, domy, kancelárie a firmy v každej časti Piešťan a okolitých obciach.",
