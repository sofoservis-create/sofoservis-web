...
export default function StahovanieTrnavaPage() {
  ...
  const heroData = {
    ...
    description:
      "Kompletné sťahovacie služby v Trnave a okolí. Profesionálny tím, výhodné ceny, spokojnosť garantovaná. Sťahujeme byty, domy, kancelárie a firmy v Trnave a blízkom okolí.",
