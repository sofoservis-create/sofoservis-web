...
export const metadata = {
  ...
  description:
    "Ponúkame komplexné služby v oblasti montáže a skladania nábytku ✅ Lacné a férové ceny ✅ Kontaktujte nás ešte dnes!",
  alternates: {
...
export default function MontazKuchynePage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne služby v oblasti montáže, skladania a inštalácie kuchynských liniek a kuchynského nábytku. Naši odborníci sa postarajú o precízne poskladanie vašej novej kuchyne od skriniek až po pracovné dosky a spotrebiče.",
  ...
  const featuresData = {
    ...
    features: [
      ...
      {
        image: "/icons/broom_icon.svg", // For clearing out old kitchen
