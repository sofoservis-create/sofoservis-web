...
export default function MontazNabytkuPage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne montáž a skladanie nábytku od 20€/hod. Naši skúsení odborníci sa postarajú o poskladanie nového nábytku alebo demontáž a presun existujúceho zariadenia rýchlo, precízne a bez poškodenia.",
