...
export const metadata = {
  ...
  description:
    "Ponúkame komplexné služby v oblasti montáže, skladania a demontáže nábytku ✅ Lacné a férové ceny ✅ Kontaktujte nás ešte dnes!",
  alternates: {
...
export default function MontazNabytkuPage() {
  ...
  const heroData = {
    ...
    description:
      "Profesionálne služby v oblasti montáže, skladania a demontáže všetkých typov nábytku. Naši skúsení odborníci sa postarajú o poskladanie nového nábytku alebo demontáž a presun existujúceho zariadenia rýchlo, precízne a bez poškodenia.",
