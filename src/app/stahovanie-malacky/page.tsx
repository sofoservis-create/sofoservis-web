...
export const metadata = {
  ...
  description:
    "Profesionálne sťahovacie služby v Malackách a okolí. Rýchlo, spoľahlivo a za výhodné ceny. Sťahujeme byty, domy, kancelárie a firmy po celých Malackách a Záhorí.",
  keywords:
