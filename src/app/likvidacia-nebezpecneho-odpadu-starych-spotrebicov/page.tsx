...
export default function LikvidaciaSpotrebicovPage() {
  ...
  const heroData = {
    ...
    description:
      "Spoľahlivé a ekologické riešenia pre likvidáciu nebezpečného odpadu a starých elektrospotrebičov. Zabezpečíme odborný odvoz a certifikovanú likvidáciu v súlade s environmentálnymi predpismi a zákonom o odpadoch.",
  ...
  const featuresData = {
    ...
    features: [
      ...
      {
        image: "/icons/broom_icon.svg", // For basement/garage clearing
