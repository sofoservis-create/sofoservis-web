...
export const blogPosts: BlogPost[] = [
  {
    slug: "stahovanie-seniorov-starsich-osob",
    title: "Sťahovanie seniorov — bezpečne a pohodlne",
    description:
      "Praktický sprievodca sťahovaním seniorov v roku 2026. Ako plánovať, čo riešiť vopred a prečo je profesionálna pomoc nevyhnutná pri sťahovaní staršej osoby.",
    publishDate: "2026-03-31",
    perex:
      "Sťahovanie seniora je iná kategória ako bežné sťahovanie. Vyžaduje si viac trpezlivosti, plánovania a ohľaduplnosti. Zostavili sme praktický sprievodca, ktorý vám pomôže celý proces zvládnuť bezpečne a bez zbytočného stresu.",
    content: [
      {
        type: "h2",
        text: "Prečo je sťahovanie seniorov náročnejšie",
      },
      {
        type: "p",
        text: "Sťahovanie staršej osoby sa líši od bežného sťahovania v niekoľkých kľúčových aspektoch. Senior má zvyčajne viac rokov nahromadených vecí, silnejšiu citovú väzbu na domov a predmety, obmedzené fyzické možnosti a väčšiu potrebu pokoja a poriadku počas celého procesu. Každá zmena prostredia je pre seniora záťažovejšia — preto je dôsledná príprava a profesionálna pomoc tak dôležitá.",
      },
      {
        type: "h2",
        text: "Krok 1 — Plánovanie s dostatočným predstihom",
      },
      {
        type: "ul",
        items: [
          "Začnite plánovať minimálne 4–8 týždňov vopred — senior potrebuje viac času na prípravu aj adaptáciu",
          "Zapojte seniora do rozhodovania — čo si zoberie, čo daruje, čo zahodí",
          "Naplánujte sťahovanie mimo víkendov a sviatkov — menej hluku a záťaže",
          "Vyhýbajte sa extrémnym teplotám — letné vedro a zimný mráz sú pre seniorov namáhavé",
          "Dohodnite termín vopred s ošetrujúcim lekárom — najmä ak senior berie lieky alebo má zdravotné obmedzenia",
          "Pripravte nový byt čo najviac vopred — čistý, teplý a zariadený základnými vecami",
        ],
      },
      {
        type: "h2",
        text: "Krok 2 — Triedenie a redukcia vecí",
      },
      {
        type: "p",
        text: "Väčšina seniorov žije v súčasnom byte alebo dome 20–40 rokov. Za ten čas sa nahromadí obrovské množstvo vecí, z ktorých sa veľká časť v novom, menšom byte uplatniť nedá. Triedenie vecí je emocionálne náročný proces — nenáhľajte sa a nevyvíjajte tlak. Nechajte seniora rozhodovať sa vlastným tempom. Odporúčame rozdeliť veci do kategórií: presúvam, darujem rodine, darujem charite a zahodím.",
      },
      {
        type: "ul",
        items: [
          "Nábytok — čo sa zmestí do nového bytu? Zmerajte pred sťahovaním",
          "Kuchynské vybavenie — v malom byte stačí tretina bežného vybavenia",
          "Oblečenie — darujte lokálnym charitám (Červený kríž, DSS)",
          "Fotografie a spomienky — digitalizujte staré fotografie, originály uchovajte",
          "Dokumenty — archivujte dôchodkové výmery, poistky, zmluvy",
          "Lieky — neprevádzajte preplnené liekárničky, konzultujte s lekárnikom",
        ],
      },
      {
        type: "rich-p",
        nodes: [
          { type: "text", text: "Ak sa byt nebude ďalej využívať a obsahuje veľa nepotrebného nábytku, môžete zvážiť aj " },
          { type: "link", text: "profesionálne vypratávanie bytu", href: "/vypratavanie-bytov-domov" },
          { type: "text", text: " — tím prevezme celú logistiku triedia a odvozu." },
        ],
      },
      {
        type: "h2",
        text: "Krok 3 — Deň sťahovania",
      },
      {
        type: "ul",
        items: [
          "Senior by nemal byť prítomný počas fyzického nosenia — hluk a chaos zvyšujú stres",
          "Zabezpečte, aby bol senior v spoločnosti blízkej osoby, ideálne mimo bytu",
          "Predmety s citovou hodnotou zabaľte osobitne a označte — nestratia sa v strese",
          "Naplánujte prestávky a dostatočný čas — neponáhľajte sa",
          "Profesionálni sťahári sú skúsení s jemným zaobchádzaním — povedzte im, čo je krehké alebo cenné",
          "Pripravte na nové miesto občerstvenie a miesto na oddych pre seniora",
        ],
      },
      {
        type: "h2",
        text: "Adaptácia na nový domov — prvé týždne sú kľúčové",
      },
      {
        type: "p",
        text: "Presťahovanie seniora do nového bytu nie je koncom procesu — je to začiatok adaptácie. Prvé 2–4 týždne sú najnáročnejšie. Senior môže byť dezorientovaný, smutný alebo neochotný. Toto je normálne. Pomôže, ak nový byt čo najviac pripomína starý — rovnaké rozmiestnenie nábytku, obľúbená stolička na rovnakom mieste, fotografii na stene. Navštevujte ho pravidelne a buďte k dispozícii na telefóne.",
      },
      {
        type: "h2",
        text: "Špeciálne situácie — sťahovanie do zariadenia sociálnych služieb",
      },
      {
        type: "p",
        text: "Ak sa senior sťahuje do DSS, domova dôchodcov alebo penziónu pre seniorov, platia ďalšie pravidlá. Väčšina zariadení má obmedzenia, čo si môže klient priniesť — veľkosť izby, zákaz nábytku nad určité rozmery, pravidlá pre elektrospotrebiče. Vopred si vyžiadajte zoznam povolených predmetov a rozmerovú schému izby. Zbytok nábytku a vecí treba odovzdať, darovať alebo uskladniť.",
      },
      {
        type: "h2",
        text: "Prečo si vybrať profesionálnu sťahovaciu firmu",
      },
      {
        type: "p",
        text: "Sťahovanie seniora zvládnete aj svojpomocne s rodinou, ale profesionálna firma prináša niekoľko zásadných výhod. Skúsený tím pracuje rýchlo a bez poškodenia nábytku, a tým minimalizuje čas expozície seniora chaosu. Firma má správne vybavenie na ťažké predmety — nie je potrebné, aby sa rodina namáhala pri nosení ťažkých skríň. A v neposlednom rade — profesionáli sú zvyknutí pracovať ohľaduplne a ticho.",
      },
      {
        type: "rich-p",
        nodes: [
          { type: "text", text: "Sofoservis realizuje sťahovanie seniorov v Bratislave a okolí. Pozrite si našu stránku " },
          { type: "link", text: "sťahovanie bytov a domov", href: "/stahovanie-bytov-domov" },
          { type: "text", text: " alebo nás priamo kontaktujte pre bezplatnú cenovú ponuku." },
        ],
      },
      {
        type: "h2",
        text: "Orientačné ceny sťahovania seniora",
      },
      {
        type: "ul",
        items: [
          "1-izbový byt: od 280 € do 420 € (vrátane práce, auta a základného balenia)",
          "2-izbový byt: od 380 € do 560 €",
          "3-izbový byt: od 520 € do 750 €",
          "Príplatok za výťah alebo nosenie po schodoch: 15–25 € za poschodie",
          "Montáž a demontáž nábytku: súčasť kompletného balíka",
        ],
      },
    ],
    faqItems: [
      {
        question: "Koľko vopred treba plánovať sťahovanie seniora?",
        answer:
          "Odporúčame začať prípravu minimálne 4–8 týždňov vopred. Senior potrebuje viac času na rozhodnutie, čo si zoberie, a viac priestoru na citové lúčenie sa s predmetmi a miestom.",
      },
      {
        question: "Má byť senior prítomný počas sťahovania?",
        answer:
          "Ideálne nie počas fyzického nosenia nábytku — hluk a chaos sú pre seniorov stresujúce. Odporúčame, aby bol senior v spoločnosti blízkej osoby mimo bytu a prišiel až keď je nové bydlisko pripravené.",
      },
      {
        question: "Čo robiť s nábytkom, ktorý sa do nového bytu nezmestí?",
        answer:
          "Nábytok v dobrom stave môžete darovať rodine, charite alebo predať na bazári. Starý a poškodený nábytok odvezieme spolu so sťahovaním — alebo môžete objednať samostatné vypratávanie zvyšku.",
      },
      {
        question: "Sťahujete aj do zariadení sociálnych služieb?",
        answer:
          "Áno, realizujeme sťahovanie do DSS, domovov dôchodcov a penziónovych zariadení. Vopred nám poskytnite rozmerovú schému izby a zoznam povolených predmetov — zabezpečíme presun len toho, čo je povolené.",
      },
      {
        question: "Ako dlho trvá sťahovanie 2-izbového bytu seniora?",
        answer:
          "Sťahovanie 2-izbového bytu trvá profesionálnemu tímu zvyčajne 3–5 hodín. Pri väčšom množstve vecí, vyšších poschodiach bez výťahu alebo väčšej vzdialenosti môže byť aj celodennú.",
      },
    ],
    relatedServices: [
      {
        title: "Sťahovanie bytov a domov",
        description: "Profesionálne sťahovanie celých domácností vrátane balenia a montáže.",
        href: "/stahovanie-bytov-domov",
        icon: "/icons/house_icon.svg",
      },
      {
        title: "Vypratávanie bytov a domov",
        description: "Odvoz starého nábytku a likvidácia nepotrebných vecí po sťahovaní.",
        href: "/vypratavanie-bytov-domov",
        icon: "/icons/vypratavanie_icon.svg",
      },
      {
        title: "Montáž nábytku",
        description: "Demontáž a opätovná montáž nábytku na novej adrese.",
        href: "/montaz-nabytku",
  ...
  {
    slug: "hodinovy-manzel-sluzby-cena",
    title: "Cenník hodinového manžela 2026 — prehľad cien a služieb",
    description:
      "Aktuálny prehľad cien hodinového manžela v roku 2026. Koľko stojí hodina, čo ovplyvňuje cenu a ako sa pripraviť na návštevu — praktický informačný sprievodca.",
    publishDate: "2026-03-29",
    perex:
      "Zaujíma vás, koľko reálne zaplatíte za hodinového manžela v roku 2026? Prinášame prehľad sadzieb, faktory ovplyvňujúce cenu a zoznam prác, ktoré bežne zvláda — všetko v jednom prehľade.",
    content: [
      {
        type: "h2",
        text: "Čo je hodinový manžel a čo dokáže vyriešiť",
      },
      {
        type: "p",
        text: "Hodinový manžel (handy man) je profesionálny pracovník, ktorý vykonáva drobné opravy, montáže a inštalácie v domácnosti alebo kancelárii. Na rozdiel od špecializovaných remeselníkov (elektrikár, inštalatér, murár) sa hodinový manžel zameriava na menšie úlohy, ktoré nevyžadujú licenciu ani špeciálne povolenie. Je to rýchle a cenovo dostupné riešenie pre bežné potreby domácnosti.",
      },
      {
        type: "h2",
        text: "Čo hodinový manžel bežne rieši",
      },
      {
        type: "ul",
        items: [
          "Montáž políc, skriniek a závesných prvkov",
          "Inštalácia záclonových tyčí, roliet a žalúzií",
          "Montáž a nastavenie dverí, zárubní a zámkov",
          "Upevnenie a oprava nábytku — uvoľnené pánty, dvierka, šuplíky",
          "Montáž svietidiel, stropných svetiel a zásuviek (bežné práce bez zasahovania do elektroinštalácie)",
          "Inštalácia televízora na stenu — TV nosič, káblový manažment",
          "Montáž kúpeľňového príslušenstva — zrkadlá, vešiaky, sprchové tyče",
          "Drobné maliarske práce — oprava odreného rohu steny, tmelenie trhlín",
          "Montáž poštových schránok, zvončekov a kamerových systémov",
          "Oprava a dotesnenie okien a dverí — výmena tesnenia, mazanie pántov",
        ],
      },
      {
        type: "h2",
        text: "Čo hodinový manžel nenahrádza",
      },
      {
        type: "p",
        text: "Hodinový manžel nie je náhrada za licencovaného špecialistu. Pre práce na hlavnom rozvode elektriny (istenie, rozvádzač), vodovodnom potrubí (rekonštrukcia, zváranie), plynovom rozvode alebo stavebné práce vyžadujúce povolenie potrebujete certifikovaného remeselníka. Hodinový manžel ale perfektne zvládne všetko, čo nevyžaduje špeciálne povolenia ani zásahy do konštrukcie.",
      },
      {
        type: "h2",
        text: "Koľko stojí hodinový manžel v roku 2026",
      },
      {
        type: "ul",
        items: [
          "Hodinová sadzba: od 25 € do 45 € za hodinu (v Bratislave zvyčajne 30–40 €)",
          "Minimálna fakturácia: väčšinou 1–2 hodiny (aj keď práca trvá menej)",
          "Materiál: účtuje sa osobitne podľa skutočnej spotreby",
          "Víkend/sviatok: príplatok 20–50 % nad základnú sadzbu",
          "Doprava: niektoré firmy účtujú príplatok za vzdialenosť nad 15 km od Bratislavy",
        ],
      },
      {
        type: "p",
        text: "Pre orientáciu: montáž 5 políc vrátane namerania, vŕtania a upevnenia trvá skúsenému pracovníkovi cca 1,5–2 hodiny = 45–80 €. Zavesenie televízora na stenu s káblovým manažmentom: 1–2 hodiny = 30–80 €. Montáž záclonových tyčí v celom byte: 2–3 hodiny = 60–120 €.",
      },
      {
        type: "h2",
        text: "Kedy sa hodinový manžel oplatí",
      },
      {
        type: "ul",
        items: [
          "Máte zoznam drobných úloh, ktoré si vyžadujú rôzne nástroje a zručnosti",
          "Nemáte čas ani chuť riešiť tieto úlohy sami",
          "Ste čerstvý nájomník alebo vlastník bytu, ktorý treba 'osadiť'",
          "Chystáte sa na sťahovanie a potrebujete demontáž alebo montáž nábytku",
          "Potrebujete profesionálny výsledok — rovné poličky, pevne ukotvené prvky",
        ],
      },
      {
        type: "rich-p",
        nodes: [
          { type: "text", text: "Sofoservis ponúka služby hodinového manžela v Bratislave a okolí. Ak sa sťahujete, hodinového manžela môžete skombinovať s " },
          { type: "link", text: "montážou nábytku", href: "/montaz-nabytku" },
          { type: "text", text: " pri sťahovaní — v jednej návšteve vyriešime demontáž, sťahovanie aj novú montáž." },
        ],
      },
      {
        type: "h2",
        text: "Hodinový manžel vs. sám — čo sa oplatí",
      },
      {
        type: "p",
        text: "Mnoho ľudí váha, či si najať hodinového manžela alebo sa pokúsiť o opravu sami. Odborná pomoc sa oplatí, keď sa jedná o prácu pri ktorej je riziko poškodenia (vŕtanie do skrytých rozvodov, upevnenie ťažkej police nad detskú postieľku), alebo keď nemáte správne náradie. Nákup špecializovaného náradia (príklepová vŕtačka, laserová vodováha, rôzne bity) môže stáť viac ako samotná služba hodinového manžela.",
      },
      {
        type: "h2",
        text: "Čo si pripraviť pred príchodom hodinového manžela",
      },
      {
        type: "ul",
        items: [
          "Pripravte zoznam všetkých úloh — šetríte čas aj peniaze",
          "Zabezpečte prístup ku všetkým priestorom, kde treba pracovať",
          "Pripravte materiál, ak ho máte — hmoždiny, skrutky, tyče",
          "Uvoľnite pracovný priestor — odsuňte nábytok, odkryte podlahu",
          "Majte k dispozícii meraciu pásku — namiery si dopredu overte polohu políc a prvkov",
        ],
      },
    ],
    faqItems: [
      {
        ...
        answer:
          "V Bratislave sa hodinová sadzba pohybuje od 30 do 45 € za hodinu. Väčšina firiem má minimálnu fakturáciu 1–2 hodiny. K tomu sa pripočíta materiál a prípadný víkendový príplatok.",
      },
      {
        question: "Môže hodinový manžel robiť elektrické práce?",
        answer:
          "Bežné práce ako montáž svietidiel, lustrov a zásuvkových líšt hodinový manžel zvládne. Práce na hlavnom elektrickom rozvode (rozvádzač, istenie) vyžadujú licencovaného elektrikára.",
      },
      {
        question: "Ako dlho vopred treba objednať hodinového manžela?",
        answer:
          "Štandardná objednávka sa dá vybaviť do 2–5 pracovných dní. V prípade súrných opráv sa snažíme prísť skôr — kontaktujte nás a dohodnem sa podľa aktuálnej dostupnosti.",
      },
      {
        question: "Dá sa skombinovať hodinový manžel so sťahovaním alebo montážou nábytku?",
        answer:
          "Áno, pri sťahovaní odporúčame túto kombináciu. Počas sťahovania sa vykonáva demontáž nábytku, a po sťahovaní do nového bytu montáž aj ďalšie drobné práce — záclony, police, TV, kúpeľňa.",
      },
      {
        question: "Aké náradie má hodinový manžel k dispozícii?",
        answer:
          "Profesionálny hodinový manžel prichádza s kompletnou sádrou náradia — vŕtačka, skrutkovač, laserová vodováha, meradlá, nôž, kliešte aj súprava na drobné elektrické práce. Nemusíte nič zabezpečovať.",
      },
    ],
    relatedServices: [
      {
        title: "Montáž nábytku",
        description: "Profesionálna montáž a demontáž nábytku všetkých značiek.",
        href: "/montaz-nabytku",
        icon: "/icons/wrench_icon.svg",
      },
      {
        title: "Sťahovanie bytov a domov",
        description: "Komplexné sťahovanie domácností vrátane balenia a montáže nábytku.",
        href: "/stahovanie-bytov-domov",
        icon: "/icons/house_icon.svg",
      },
      {
        title: "Montáž kuchyne",
        description: "Odborná montáž kuchynskej linky vrátane spotrebičov.",
        href: "/montaz-kuchyne",
  ...
  {
    slug: "odovzdanie-bytu-po-najme-checklist",
    title: "Odovzdanie bytu po nájme — checklist a tipy",
    description:
      "Ako správne odovzdať byt prenajímateľovi a dostať zálohu späť. Checklist: čo upratať, čo opraviť a ako sa vyhnúť sporom pri odovzdaní nájomného bytu.",
    publishDate: "2026-03-27",
    perex:
      "Blíži sa koniec nájmu a vy si nie ste istí, čo všetko treba pred odovzdaním urobiť? Záloha na byt môže byť aj niekoľko stoviek eur — dôkladná príprava pred odovzdaním je tou najlepšou investíciou.",
    content: [
      {
        type: "h2",
        text: "Čo hovorí zákon o odovzdaní bytu",
      },
      {
        type: "p",
        text: "Podľa slovenského práva (zákon č. 40/1964 Zb., Občiansky zákonník) je nájomník povinný vrátiť byt v stave, v akom ho prevzal, s prihliadnutím na bežné opotrebenie. Bežné opotrebenie zahŕňa vyblednutie farby stien, menšie škrabance na podlahe alebo opotrebenie kľučiek. Poškodenie nad rámec bežného opotrebenia (veľké diery v stenách, rozbitá dlažba, poškodený nábytok) môže prenajímateľ odpočítať zo zálohy. Preto je dôkladná príprava pred odovzdaním tak dôležitá.",
      },
      {
        type: "h2",
        text: "Kedy začať s prípravou na odovzdanie",
      },
      {
        type: "ul",
        items: [
          "6 týždňov pred odovzdaním: skontrolujte stav bytu a identifikujte poškodenia nad bežné opotrebenie",
          "4 týždne: doobjednajte maliarov, remeselníkov ak treba — dobrí pracovníci sú obsadení",
          "2 týždne: začnite s upratovaním, odvozom starých vecí a balením",
          "Týždeň pred: generálna očista — kuchyňa, kúpeľňa, podlahy, okná",
          "Deň pred odovzdaním: finálna prehliadka, fotodokumentácia",
          "V deň odovzdania: odovzdanie kľúčov a písomný protokol",
        ],
      },
      {
        type: "h2",
        text: "Kompletný checklist pred odovzdaním bytu",
      },
      {
        type: "h3",
        text: "Steny a stropy",
      },
      {
        type: "ul",
        items: [
          "Vyplňte diery po obrázkoch a poličkách (tmel + farba)",
          "Opravte veľké škrabance alebo odreté plochy",
          "Skontrolujte, či nie sú na stenách nálepky, kresby alebo graffiti",
          "Vyčistite skvrny (tuk, vlhkosť, pleseň)",
          "Prehliadnite strop — skvrny od netesnosti alebo dymu",
        ],
      },
      {
        type: "h3",
      ...
      },
      {
        type: "ul",
        items: [
          "Vyčistite parkety, vinyl alebo laminát do hĺbky",
          "Skontrolujte, či nie sú na podlahe výrazné škrabance nad bežné opotrebenie",
          "Dlažbu: vyčistite škáry, odstráňte skvrny",
          "Koberec: dajte na čistenie alebo profesionálne vyčistite na mieste",
        ],
      },
      {
        type: "h3",
      ...
      },
      {
        type: "ul",
        items: [
          "Rúra: kompletné odmastiť vrátane skla a grilu",
          "Sporák: vyčistiť horáky a plošiny",
          "Odsávač pár: vyčistiť filter, vnútro a exteriér",
          "Chladnička a mraznička: vyčistiť, odmraziť, nechať otvorené",
          "Kuchynská linka: vnútro skriniek, pracovná doska bez zápariek",
          "Drez: odstrániť vodný kameň, odtok bez zápachu",
          "Umývačka (ak je): vyčistiť filter, spustiť prázdny cyklus",
        ],
      },
      {
        type: "h3",
        text: "Kúpeľňa a toaleta",
      },
      {
        type: "ul",
        items: [
          "Odstrániť vodný kameň z kohútikov, sprchovacieho koša a vaničky",
          "Vyčistiť škáry v obkladoch — tmel bez plesne",
          "Toaleta: dezinfikovaná vrátane rezervoára a splachovania",
          "Zrkadlo: bez škvŕn a vodného kameňa",
          "Skrinka: prázdna a vyčistená",
        ],
      },
      {
        type: "h3",
        text: "Okná, dvere, balkón",
      },
      {
        type: "ul",
        items: [
          "Okná: umyté zvnútra aj zvonka vrátane rámu a parapetu",
          "Žalúzie a roletky: bez prachu a deformácií",
          "Dvere: skontrolujte tesnenie, pánty a zámky — prievan a vrzganie sú závadou",
          "Balkón: zamiesť, umyť dlažbu, odstrániť kvetináče a veci",
        ],
      },
      {
        type: "rich-p",
        nodes: [
          { type: "text", text: "Ak potrebujete pred odovzdaním odviezť starý nábytok, prebytočné veci alebo stavebný odpad, pomôže vám naša služba " },
          { type: "link", text: "odvoz starého nábytku", href: "/vypratavanie-odvoz-stareho-nabytku" },
          { type: "text", text: " — príjazd do 2–5 dní, odvoz a ekologická likvidácia zahrnutá." },
        ],
      },
      {
        type: "h2",
        text: "Fotodokumentácia — váš najlepší právny doklad",
      },
      {
        type: "p",
        text: "Pred odovzdaním dôsledne odfotografujte každú miestnosť, každý detail — steny, podlahy, kuchynské spotrebiče, kúpeľňu. Fotografie s časovou pečiatkou sú pri prípadnom spore vaším kľúčovým dôkazom. Ideálne porovnajte so vstupným protokolom a fotografiami z prevzatia bytu. Ak vstupný protokol neexistuje alebo bol vágny, toto je váš úniku.",
      },
      {
        type: "h2",
        text: "Odovzdávací protokol — čo musí obsahovať",
      },
      {
        type: "ul",
        items: [
          "Stav merača elektrickej energie, plynu a vody v deň odovzdania",
          "Počet odovzdaných kľúčov a kariet",
          "Zoznam poškodení (ak nejaké sú) s popisom a dohodnutou kompenzáciou",
          "Podpis oboch strán — nájomníka aj prenajímateľa",
          "Dátum a čas odovzdania",
          "Dohoda o vrátení zálohy — lehota a spôsob vrátenia",
        ],
      },
      {
        type: "h2",
        text: "Čo robiť, ak prenajímateľ neoprávnene zráža zálohu",
      },
      {
        type: "p",
        text: "Ak prenajímateľ odmietne vrátiť zálohu alebo ju neoprávnene zráža, máte niekoľko možností. Prvým krokom je písomná výzva (doporučený list) s lehotou 15 dní na vrátenie zálohy. Ak to nepomôže, môžete podať návrh na vydanie platobného rozkazu na príslušnom okresnom súde. Pre sumy do 2 000 € je konanie jednoduché a nevyžaduje advokáta. Uchovajte si všetku dokumentáciu — zmluvu, protokoly, fotografie, komunikáciu.",
      },
    ],
    faqItems: [
      {
        question: "Musím byt pred odovzdaním vymaľovať?",
        answer:
          "Nie je to povinnosť zo zákona, pokiaľ steny nie sú poškodené nad rámec bežného opotrebenia. Ak ste v byte bývali dlhšie a steny sú len vyblednuté, maľovanie nie je vaša povinnosť. Ak sú steny zašpinené, poškriabané alebo popozerané, oprava je na vás.",
      },
      {
        question: "Čo je bežné opotrebenie bytu?",
        answer:
          "Bežné opotrebenie sú prirodzené zmeny spôsobené normálnym užívaním — vyblednuté steny, drobné škrabance na podlahe, opotrebené kľučky. Nie je to poškodenie spôsobené nedbalosťou — veľké diery v stenách, rozbitá dlažba, výrazné škrabance na drevených podlahách.",
      },
      {
        question: "Kedy mi prenajímateľ musí vrátiť zálohu?",
        answer:
          "Zákon neustanovuje presnú lehotu, ale súdna prax hovorí o 30 dňoch od skončenia nájmu a odovzdania bytu. Ak prenajímateľ zálohu nezašle ani po písomnej výzve, môžete podať návrh na platobný rozkaz.",
      },
      {
        question: "Môžem si pred odovzdaním dať byt profesionálne vyčistiť?",
        answer:
          "Áno, profesionálny upratovací servis je dobrá investícia — výsledok je lepší ako domáce upratovanie a prenajímateľ ťažšie namieta pri odovzdaní. Náklady sú 80–200 € podľa veľkosti bytu.",
      },
      {
        question: "Čo ak sa v byte našla pliseň, ktorú som nespôsobil ja?",
        answer:
          "Pliseň spôsobená konštrukčnou závadou budovy (zlá izolácia, netesná strecha) nie je vaša zodpovednosť. Pliseň spôsobená nedostatočným vetraním je sporná. Dôležité je mať pri odovzdaní dokumentáciu — kedy sa objavila a čo ste robili na jej odstraňovanie.",
      },
    ],
    relatedServices: [
      {
        title: "Odvoz starého nábytku",
        description: "Rýchly odvoz a ekologická likvidácia nepotrebného nábytku a odpadu.",
        href: "/vypratavanie-odvoz-stareho-nabytku",
        icon: "/icons/recycle_icon.svg",
      },
      {
        title: "Vypratávanie bytov a domov",
        description: "Kompletné vypratanie bytu pred odovzdaním — nábytok, odpad aj upratanie.",
        href: "/vypratavanie-bytov-domov",
        icon: "/icons/vypratavanie_icon.svg",
      },
      {
        title: "Sťahovanie bytov a domov",
        description: "Profesionálne sťahovanie celej domácnosti na novú adresu.",
        href: "/stahovanie-bytov-domov",
        icon: "/icons/house_icon.svg",
      },
    ],
  },
  {
    ...
    title: "Prenájom auta vs. sťahovacia firma — výber",
    description:
  ...
  },
  {
    ...
    title: "Vypratávanie bytu po zosnulom 2026 — právny postup a praktické rady",
    description:
      "Ako postupovať pri vypratávaní bytu po zosnulom v roku 2026. Právne náležitosti, dedičské konanie, postup krok za krokom a rady, ako zvládnuť túto ťažkú situáciu.",
    publishDate: "2026-03-24",
    perex:
      "Strata blízkeho je emocionálne náročná a vypratávanie bytu po zosnulom môže byť jednou z najťažších úloh. Pripravili sme sprievodcu — od prvých krokov pri dedičskom konaní po praktickú organizáciu odvozu.",
    content: [
      {
        type: "h2",
  ...
  },
  {
    ...
    title: "Sťahovanie s domácimi zvieratami — tipy",
    description:
  ...
  },
  {
    ...
    title: "Odvoz stavebného odpadu po rekonštrukcii 2026 — postup krok za krokom",
    description:
      "Ako správne triediť a odviezť stavebný odpad po rekonštrukcii v roku 2026. Legislatíva, typy odpadu, ceny a praktický postup — informačný sprievodca.",
    publishDate: "2026-03-22",
    perex:
      "Po rekonštrukcii bytu alebo domu zostáva množstvo stavebného odpadu — sutiny, staré obklady, sadrokartón, drevo, kovy. Ako odpad správne roztriediť, kde ho odviezť a čomu sa vyhnúť pri jeho likvidácii v roku 2026?",
    content: [
      {
        type: "h2",
  ...
  },
  {
    ...
    title: "Sťahovanie v zime — výhody, výzvy a tipy",
    description:
  ...
  },
  {
    ...
    title: "Ako sa sťahuje klavír a ťažké predmety — postup, riziká a odporúčania",
    description:
      "Čo obnáša sťahovanie klavíra, trezoru alebo priemyselného stroja? Postup, riziká pri svojpomocnom prenose, potrebné vybavenie a rady pre rok 2026.",
    publishDate: "2026-03-20",
    perex:
      "Klavír, trezor alebo priemyselný stroj — sťahovanie týchto predmetov vyžaduje iný prístup ako bežné sťahovanie. V tomto článku sa dozviete, prečo je to tak, aké riziká hrozia a ako celý proces prebieha.",
    content: [
      {
        type: "h2",
  ...
  },
  {
    ...
    title: "Vypratávanie pivníc a skladov v Bratislave",
    description:
  ...
  },
  {
    ...
    title: "Vypratávanie po sezónnom uskladnení Bratislava",
    description:
  ...
  },
  {
    ...
    title: "Ako si vybrať sťahovaciu firmu — 10 kritérií",
    description:
  ...
  },
  {
    ...
    title: "Medzinárodné sťahovanie 2026 — dokumenty, clo a praktické tipy",
    description:
      "Čo treba vedieť o medzinárodnom sťahovaní v roku 2026. Colné formality, potrebné dokumenty, legislatíva EÚ a tipy na prípravu — informačný sprievodca bez komerčných klišé.",
    publishDate: "2026-03-05",
    perex:
      "Sťahujete sa do zahraničia alebo sa vraciate na Slovensko? Medzinárodné sťahovanie prináša otázky o dokumentoch, cle a legislatíve. V tomto sprievodcovi nájdete odpovede — bez žargónu, krok za krokom.",
    content: [
      {
        type: "h2",
  ...
  },
  {
    ...
    title: "Sťahovanie kancelárie 2026 — tipy a checklist",
    description:
      "Plánujete sťahovanie kancelárie v roku 2026? Zistite, ako minimalizovať výpadok prevádzky, ochrániť IT vybavenie a zorganizovať firemné sťahovanie.",
  ...
  },
  {
    ...
    title: "Montáž nábytku IKEA 2026 — cena a odborník",
    description:
  ...
  },
  {
    ...
    title: "Cena vypratávania bytu 2026 — čo ovplyvňuje sumu a ako ušetriť",
    description:
      "Koľko stojí vypratávanie bytu v roku 2026 — vrátane cien v Bratislave? Prehľad faktorov, ktoré ovplyvňujú výslednú sumu, a praktické tipy na úsporu. Informačný článok.",
    publishDate: "2026-02-05",
    perex:
      "Vypratávanie bytu môže byť fyzicky aj finančne náročné. V tomto článku sa dozviete, čo všetko ovplyvňuje cenu — v Bratislave aj mimo nej — aké sú aktuálne ceny v roku 2026 a ako si celý proces zorganizovať čo najefektívnejšie.",
    content: [
      {
        type: "h2",
  ...
  },
  {
    ...
    title: "Ako sa pripraviť na sťahovanie 2026 — checklist a tipy na balenie",
    description:
      "Kompletný checklist na prípravu sťahovania v roku 2026. Čo urobiť 4 týždne, 2 týždne a deň pred sťahovaním, ako správne baliť krehké veci a aký materiál použiť.",
    publishDate: "2026-01-20",
    perex:
      "Dobre naplánované sťahovanie šetrí čas, peniaze a nervy. Prinášame overený checklist, ktorý vás prevedie celou prípravou — od výberu baliaceho materiálu až po prvú noc v novom domove.",
    content: [
      {
        type: "h2",
  ...
  },
  {
    ...
    title: "Koľko stojí sťahovanie v Bratislave 2026",
    description:
